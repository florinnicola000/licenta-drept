...
// 158 termeni: Civil · Penal · Proc. Civ. · Proc. Pen. · Latină juridică
...
{t:'uzucapiune',mat:'civ',art:'art. 930-934 C.civ.',d:'Mod originar de dobândire a dreptului de proprietate prin posesia utilă a unui bun pe durata prevăzută de lege. Extratabulară (art. 930): posesie utilă 10 ani. Tabulară (art. 931): înscriere în CF cu bună-credință + 5 ani.'},
{t:'uzucapiune tabulară',mat:'civ',art:'art. 931 C.civ.',d:'Dobândirea dreptului de proprietate imobiliară de către cel care s-a înscris cu bună-credință în cartea funciară, fără cauză legitimă, pe baza unui titlu translativ, prin posedarea bunului timp de 5 ani de la înscriere.'},
{t:'uzucapiune extratabulară',mat:'civ',art:'art. 930 C.civ.',d:'Dobândirea dreptului de proprietate imobiliară prin posesia utilă timp de 10 ani, când bunul nu e înscris în cartea funciară ori titularul înscris a decedat sau a renunțat la drept. Dreptul se înscrie în CF pe baza cererii de uzucapiune.'},
...
{t:'fructe',mat:'civ',art:'art. 548 alin.(1)-(3) C.civ.',d:'Produse periodice ale unui bun care nu consumă substanța acestuia. Trei tipuri: naturale (recolta, lâna), industriale (produse cu concursul muncii), civile (chirii, dobânzi). Se cuvin de regulă proprietarului; posesorul de bună-credință le dobândește prin simpla percepere. Opp: producte.'},
{t:'producte',mat:'civ',art:'art. 548 alin.(4) C.civ.',d:'Produse ale unui bun care consumă substanța acestuia (ex: minereu extras din mină, piatră din carieră, copacii dintr-o pădure tăiată). Nu se reproduc periodic. Opp: fructe. Posesorul de rea-credință trebuie să le restituie proprietarului.'},
...
{t:'arendare',mat:'civ',art:'art. 1836-1850 C.civ.',d:'Varietate a locațiunii prin care arendatorul transmite arendașului exploatarea agricolă a unui bun (teren, animale, utilaje) în schimbul arendei (bani sau produse). Formă scrisă ad validitatem; durată nedeterminată → anul agricol în curs; subarendarea interzisă; arendașul are drept de preemțiune la vânzarea terenului.'},
{t:'depozit',mat:'civ',art:'art. 2103-2143 C.civ.',d:'Contract prin care deponentul remite un bun mobil depozitarului, care se obligă să-l conserve și să-l restituie în natură la cerere sau la termen. De regulă gratuit. Tipuri: voluntar, necesar (forțat de împrejurări — cutremur, incendiu), sechestru convențional (bun litigios).'},
{t:'tranzacție',mat:'civ',art:'art. 2267-2278 C.civ.',d:'Contract prin care părțile sting un litigiu existent sau previn unul viitor prin concesii reciproce. Are putere de lucru judecat între părți (excepție de fond, opozabilă la un nou proces). Dacă e autentificată notarial sau consfințită de instanță, devine titlu executoriu.'},
...
{t:'dezmoștenire',mat:'civ',art:'art. 1074-1076 C.civ.',d:'(exheredare) Dispoziție testamentară prin care testatorul înlătură de la moștenire un moștenitor legal. Directă: clauză expresă în testament. Indirectă: legat universal dat altcuiva. Nu poate suprima rezerva moștenitorului rezervatar — dezmoștenirea e eficientă doar în limita cotității disponibile.'},
{t:'raport succesoral',mat:'civ',art:'art. 1146-1154 C.civ.',d:'Obligația descendentului sau soțului supraviețuitor care a primit donații de la defunct de a readuce acele valori în masa succesorală, pentru egalarea cotelor celorlalți moștenitori. Dispensa de raport poate fi stipulată expres de donator; în lipsă, raportul e datorat.'},
...
{t:'acțiune posesorie',mat:'pciv',art:'art. 1003-1008 C.pr.civ.',d:'Acțiunea prin care posesorul perturbat sau deposedat cere instanței protejarea posesiei, fără a intra în fondul dreptului de proprietate. Două forme: complânda (tulburare sau deposedare non-violentă) și reintegranda (deposedare prin violență). Termen: 1 an de la tulburare/deposedare.'},
{t:'complânda',mat:'pciv',art:'art. 1003-1005 C.pr.civ.',d:'Acțiunea posesorie de drept comun, exercitată de posesorul tulburat sau deposedat altfel decât prin violență. Condiții: posesie utilă de cel puțin 1 an și acțiunea introdusă în termen de 1 an de la data tulburării sau deposedării. Instanța nu cercetează fondul dreptului.'},
{t:'reintegranda',mat:'pciv',art:'art. 1003-1004 C.pr.civ.',d:'Acțiunea posesorie specială, exercitată de cel deposedat prin violență sau printr-o tulburare de fapt violentă. Nu necesită dovada posesiei de 1 an — se acordă oricărui posesor sau detentor precar. Termenul de introducere: 1 an de la data deposedării violente.'},
{t:'contestație în anulare',mat:'pciv',art:'art. 503-507 C.pr.civ.',d:'Cale extraordinară de atac de retractare (la instanța care a pronunțat hotărârea) împotriva hotărârilor civile definitive, pentru vicii grave de procedură: instanța nu a fost legal sesizată, dezlegarea dată recursului e afectată de o eroare materială, nu s-a sesizat CJUE deși era obligat etc.'},
{t:'revizuire',mat:'pciv',art:'art. 509-513 C.pr.civ.',d:'Cale extraordinară de atac civilă de retractare, prin care se cere desființarea și rejudecarea cauzei definitive pe baza unor motive limitativ enumerate: înscris declarat fals ulterior, martor condamnat pentru mărturie mincinoasă, hotărâri contradictorii, hotărâre CEDO de constatare a violării etc.'},
// ─── PROCEDURĂ PENALĂ ───────────────────────────────────────────────────
...
{t:'contestație în anulare (pen.)',mat:'ppen',art:'art. 426-432 C.pr.pen.',d:'Cale extraordinară de atac de retractare împotriva hotărârilor penale definitive, pentru motive limitativ prevăzute: judecata s-a produs în lipsa citării legale a inculpatului; instanța nu era competentă; un judecător incompatibil a participat la soluționarea recursului în casație etc.'},
{t:'revizuire (pen.)',mat:'ppen',art:'art. 452-465 C.pr.pen.',d:'Cale extraordinară de atac penală de retractare: rejudecarea cauzei soluționate definitiv pe baza unor fapte sau mijloace de probă noi, necunoscute la soluționarea cauzei (inclusiv mărturie mincinoasă constatată ulterior, hot. CEDO). Poate fi exercitată și în favoarea condamnatului decedat.'},
{t:'excluderea probelor',mat:'ppen',art:'art. 102 C.pr.pen.',d:'Sancțiunea prin care probele obținute prin tortură, coerciție sau cu nerespectarea legii sunt eliminate din dosar și nu pot fundamenta condamnarea. Verificată în faza de cameră preliminară. Probele derivate dintr-o probă exclusă sunt la rândul lor înlăturate (teoria „fructului pomului otrăvit").'},
...
{t:'contumace',mat:'lat',d:'„În lipsă, cu refuzul de a se prezenta." Termen care desemnează situația celui judecat în absență, deși legal citat. NCPC permite judecata în lipsă ca regulă — pârâtul absent pierde dreptul de a mai depune probe; NCPP reglementează distinct judecata în lipsă a inculpatului (art. 364 C.pr.pen.), cu garanții specifice.'},
];
