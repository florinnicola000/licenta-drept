...
var FISE_DATA = [
  {
    ...
    title:'Izvoare, aplicarea legii, AJC, capacitate',
    sections:[
      { icon:'📚', title:'Izvoarele dreptului civil (art. 1 NCC)',
        items:[
          '<b>Legea</b> = izvorul principal. Art. 1 NCC enumeră izvoarele: <b>legea, uzanțele și principiile generale ale dreptului</b>. „Legea" în sens larg = Constituția, codurile, legile organice/ordinare, OUG, OG, actele normative subsecvente (HG, ordine, regulamente).',
          '<b>Uzanțele</b> (art. 1 alin. 2–6 NCC) = <b>obiceiul (cutuma) și uzurile profesionale</b>. ⚠️ Se aplică <b>numai în cazurile neprevăzute de lege</b>. Ordinea de aplicare: (1) în materiile reglementate de lege, uzanțele se aplică <b>numai dacă legea trimite expres la ele</b>; (2) în cazurile <b>neprevăzute de lege</b>, se aplică uzanțele, iar în lipsa lor <b>dispozițiile legale privitoare la situații asemănătoare</b> (analogia legii), iar în absența acestora <b>principiile generale</b> (analogia dreptului). Numai uzanțele <b>conforme ordinii publice și bunelor moravuri</b> sunt recunoscute ca izvor.',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q20]</b> Acțiunea revocatorie <span style="color:var(--sub);font-size:0.9em">a) introdusă cu succes de către un creditor chirografar profită tuturor creditorilor chirografari ai respectivului debitor · b) nu se aplică faptelor juridice stricto sensu · c) dacă se referă la un contract de donație, presupune condiția fraudei debitorului și a complicității terțului la fraudă</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">acțiunea revocatorie (pauliană) vizează, potrivit art. 1562 C.civ., actele juridice încheiate de debitor în frauda creditorului, n…</span>',
          '📌 <b>[Iul 2026 · G4 · Q9]</b> In cazul încheierii, în numele persoanei juridice, a unui contract pentru care legea ce… <span style="color:var(--sub);font-size:0.9em">a) contractul este valabil numai dacă persona juridică este reprezentată de către organul său de conducere · b) organul de administrare al persoanei juridice poate să reprezinte valabil persona juridică, chiar fără a avea o procură specială care să îmbrace forma autentică · c) dacă reprezentantul legal își depășește puterile de reprezentare fixate prin actele constitutive regulat publicate, contractul nu va fi al persoanei juridice, chiar dacă cealaltă parte contractantă nu a cunoscut efectiv această neregularitate</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">persoana juridică își exercită drepturile prin organele de administrare, care o reprezintă în temeiul legii, nu al unui mandat (ar…</span>'
        ]
      },
      { icon:'🕰️', title:'Aplicarea legii civile în timp și spațiu (art. 6 NCC)',
        items:[
          '<b>Principiul neretroactivității</b> (art. 6 alin. 1 NCC + art. 15 alin. 2 Constituție): legea nouă se aplică numai situațiilor <b>ivite după intrarea ei în vigoare</b>. Excepția constituțională: legea penală sau contravențională <b>mai favorabilă</b>.',
          '<b>Facta praeterita</b> (fapte trecute, epuizate sub legea veche): rămân guvernate de <b>legea veche</b> — actele/faptele juridice încheiate, modificate, stinse sau, după caz, produse înainte de intrarea în vigoare a legii noi (art. 6 alin. 2). Nulitatea, cauzele de nulitate, prescripția începută → legea în vigoare la data faptului.',
          '<b>Facta pendentia și facta futura</b> (situații în curs / viitoare): art. 6 alin. 5–6 NCC — <b>efectele viitoare</b> ale situațiilor juridice născute sub legea veche se supun <b>legii noi</b> (aplicarea imediată), dacă situația continuă să se producă. Ex: efectele viitoare ale unei căsătorii, ale proprietății, ale contractelor cu executare succesivă.',
          '⚠️ <b>Ultraactivitatea legii vechi</b>: prin excepție, contractele cu executare succesivă (locațiune, întreținere) încheiate sub legea veche rămân supuse <b>legii vechi</b> pentru tot ce ține de încheierea, interpretarea, efectele și încetarea lor (art. 102 Legea 71/2011). Prescripțiile începute sub legea veche → legea veche (art. 201 L. 71/2011).',
          '<b>Aplicarea în spațiu</b>: <b>teritorialitatea</b> — legea civilă română se aplică pe teritoriul României. Conflictele de legi în spațiu (element de extraneitate) se rezolvă prin <b>normele de drept internațional privat</b> (Cartea a VII-a NCC, art. 2557 și urm.): <i>lex rei sitae</i> (bunuri), <i>lex personalis / lex patriae</i> (statutul persoanei), <i>lex loci actus</i> (forma actului), <i>lex voluntatis</i> (contracte).'
        ]
      },
      ...
      { icon:'🏢', title:'Persoana juridică — elemente, înființare, reorganizare, încetare (art. 187–251 NCC)',
        items:[
          '<b>Cele 3 elemente constitutive</b> (art. 187 NCC), cumulative: (1) <b>organizare de sine stătătoare</b> (structură proprie); (2) <b>patrimoniu propriu</b>, distinct de al membrilor; (3) <b>scop licit și moral</b>, în acord cu interesul general. Lipsa oricăruia → PJ nu ia ființă valabil.',
          '<b>Înființarea</b> (art. 194 NCC): (1) prin <b>actul de înființare al organului competent</b> (autorități publice — PJ de drept public, prin lege/HG); (2) prin <b>actul de înființare al celor care o constituie, autorizat</b> (asociații, fundații — Legea 26/2000, OG 26/2000); (3) în <b>orice alt mod prevăzut de lege</b> (societăți — Legea 31/1990, prin înmatriculare la registrul comerțului).',
          '<b>Capacitatea de folosință</b> (art. 205–208 NCC): PJ supuse înregistrării o dobândesc de la data <b>înregistrării</b>; celelalte, de la data actului de înființare/autorizării/altui mod. <b>Capacitatea anticipată</b>: chiar de la data actului de înființare, PJ poate dobândi drepturile și-și poate asuma obligațiile <b>necesare pentru a lua ființă valabil</b> (art. 205 alin. 3).',
          '<b>Principiul specialității</b> (art. 206 NCC): ⚠️ vizează <b>numai PJ fără scop lucrativ</b> — pot avea doar drepturile și obligațiile necesare realizării <b>scopului statutar</b>. Actele încheiate cu depășirea acestuia = <b>nulitate absolută</b> (art. 206 alin. 3, expres). PJ cu scop lucrativ pot avea orice drepturi, cu excepția celor ce nu pot aparține decât persoanei fizice.',
          '<b>Capacitatea de exercițiu</b> (art. 209–211 NCC): PJ își exercită drepturile prin <b>organele de administrare</b> (persoane fizice/juridice desemnate). Actele organelor, în limitele puterilor conferite, sunt <b>actele PJ înseși</b>. Actele încheiate cu depășirea puterilor → PJ poate fi ținută față de terții de bună-credință.',
          '<b>Reorganizarea</b> (art. 232–243 NCC): (1) <b>fuziunea</b> — prin absorbție (o PJ o încorporează pe alta) sau contopire (două+ PJ formează una nouă); (2) <b>divizarea</b> — totală (PJ se împarte și încetează) sau parțială (desprindere de patrimoniu). Efect: <b>transmisiune universală sau cu titlu universal</b> a patrimoniului. Drepturile și obligațiile trec la PJ dobânditoare.',
          '<b>Încetarea</b> (art. 244–251 NCC): prin <b>constatarea/declararea nulității</b>, <b>fuziune/divizare totală</b>, <b>transformare</b> sau <b>dizolvare urmată de lichidare</b>. ⚠️ După dizolvare, PJ intră în lichidare și <b>păstrează capacitatea numai pentru operațiunile de lichidare</b>. PJ încetează la data <b>radierii</b> din registrul în care e înscrisă.',
          '<b>Nulitatea PJ</b> (art. 196–199 NCC): cauze limitativ prevăzute (lipsa actului de înființare, obiect ilicit, lipsa autorizării, incapacitatea fondatorilor etc.). ⚠️ Nulitatea PJ <b>nu retroactivează</b> — de la data rămânerii definitive a hotărârii, PJ încetează <b>fără efect retroactiv</b> și intră în lichidare (art. 198). Actele încheiate în numele PJ rămân valabile.'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'📌', title:'Condiții de valabilitate a consimțământului',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q4]</b> În materia viciilor de consimțământ <span style="color:var(--sub);font-size:0.9em">a) atunci când dolul provine de la un terț, cocontractantul victimei nu trebuie să fi încheiat contractul cu intenția de a induce în eroare victima dolului · b) Codul civil prevede posibilitatea adaptării atât în caz de eroare esențială cât și în caz de dol, întrucât acesta reprezintă o eroare provocată · c) dacă X, vecinul lui Y, profită de incendiul izbucnit în timpul nopții în locuința lui Y pentru a obține de la acesta un preț de 3 ori mai mare decât prețul mediu de piață, pentru vânzarea unui extinctor, contractul este anulabil numai pentru leziune</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1215 C.civ., când dolul provine de la un terț, anularea se poate cere dacă cocontractantul a cunoscut sau trebuia să…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'📦', title:'Obiectul AJC (art. 1225–1234 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q1]</b> În materia izvoarelor dreptului civil <span style="color:var(--sub);font-size:0.9em">a) practicile constante pe care A și B le utilizează în relația contractuală dintre ele au natura juridică a unor uzanțe normative · b) principiile generale ale dreptului civil se pot aplica în lipsa uzanțelor normative, dar prioritar față de dispoziții legale privitoare la situații asemănătoare. · c) caracterul normativ al uzanțelor este independent de publicarea acestora într-o culegere elaborată de un organism autorizat</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1 alin. (5) C.civ., publicarea uzanțelor în culegeri elaborate de entități autorizate creează doar o prezumție de ex…</span>',
          '📌 <b>[Iul 2026 · G2 · Q14]</b> In materia folosinței ce intră în conținutul dreptului de proprietate privată <span style="color:var(--sub);font-size:0.9em">a) posibilitatea proprietarului de a nu utiliza bunul este limitată de lege în anumite cazuri în funcție de natura și destinația bunului · b) fructele civile se dobândesc prin acte materiale sau juridice · c) pasivitatea proprietarului de a culege fructele naturale nu reprezintă un act de dispoziție</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">libertatea proprietarului de a nu uza de bun este limitată legal în anumite cazuri, în funcție de natura și destinația bunului – e…</span>',
          '📌 <b>[Iul 2026 · G1 · Q2]</b> Aveți în vedere următoarea situație: i) la 10.01.2023 intră în vigoare o lege care, sub… <span style="color:var(--sub);font-size:0.9em">a) contractul de închiriere semnat la data de 10.06.2022, pentru o durată de 5 ani și o chirie lunară superioară plafonului, este valabil, dar chiriașul va datora, începând cu data intrării în vigoare a legii noi, o chirie egală cu plafonul · b) contractul de închiriere încheiat înainte de intrarea în vigoare a legii noi este valabil, iar chiriașul va datora chiria prevăzută în contract și după data intrării în vigoare a legii noi, chiar dacă aceasta ar fi superioară plafonului impus de legea nouă · c) contractul de închiriere semnat înainte de intrarea în vigoare a legii noi va fi parțial anulabil dacă prevede o chirie superioară plafonului rezultat din legea nouă. refacerea actului; b) îndeplinirea condiției de validitate ulterior încheierii actului nu este o cauză generală de acoperire a nulității, aplicabilă pentru orice act juridic și pentru orice motiv de nulitate; c) în cazul unui contract anulabil pentru leziune, confirmarea este o cauză de acoperire a nulității aflată la dispoziția cocontractantului celui lezat, dacă menționatul cocontractant al celui lezat oferă, în mod echitabil, majorarea propriei prestații</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 6 alin. (2) și (3) C.civ. și principiului neretroactivității (art. 15 alin. (2) Constituție), validitatea și efectel…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'↩️', title:'Efectele nulității (art. 1254–1265 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q3]</b> În materia cauzelor de acoperire a nulității actului juridic civil <span style="color:var(--sub);font-size:0.9em">a) confirmarea actului produce efect retroactiv, ca și refacerea actului · b) îndeplinirea condiției de validitate ulterior încheierii actului nu este o cauză generală de acoperire a nulității, aplicabilă pentru orice act juridic și pentru orice motiv de nulitate · c) în cazul unui contract anulabil pentru leziune, confirmarea este o cauză de acoperire a nulității aflată la dispoziția cocontractantului celui lezat, dacă menționatul cocontractant al celui lezat oferă, în mod echitabil, majorarea propriei prestații</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1261 alin. (2) C.civ., nulitatea poate fi acoperită prin confirmare sau prin alte moduri anume prevăzute de lege; în…</span>',
          '📌 <b>[Iul 2026 · G1 · Q7]</b> Dacă A vinde către C un imobil pentru care legea specială pretinde respectarea dreptulu… <span style="color:var(--sub);font-size:0.9em">a) înscrierii imobilului în cartea funciară de către C, dacă acest moment este anterior cunoașterii efective a vânzării de către B · b) întotdeauna de la data cunoașterii efective, de către B, a vânzării menționate · c) de la data cunoașterii efective a vânzării de către B, dar nu mai târziu de împlinirea unui termen de 18 luni de la data vânzării;</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">B este un terț îndreptățit să invoce nulitatea relativă, iar potrivit art. 2529 alin. (2) C.civ., când nulitatea relativă poate fi…</span>',
          '📌 <b>[Iul 2026 · G1 · Q8]</b> Dacă în interiorul termenului de repunere în termenul de prescripție extinctivă a acțiu… <span style="color:var(--sub);font-size:0.9em">a) se suspendă termenul de prescripție aplicabil dreptului la realizarea creanței, pentru că acesta se prelungește până la expirarea termenului de repunere în termen · b) se suspendă de drept cursul termenului de repunere în termen, pentru că acesta este un termen de prescripție · c) termenul de repunere în termen nu se suspendă, pentru că este un termen de decădere</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">termenul de 30 de zile pentru repunerea în termen (art. 2522 alin. (2) C.civ.) este calificat, în doctrina majoritară, ca termen d…</span>'
        ]
      },
...

  {
    ...
    sections:[
      ...
      { icon:'🏛️', title:'Dreptul de proprietate publică (art. 858–875 NCC)',
        items:[
          '<b>Titularii</b> (art. 858 NCC): <b>statul</b> (domeniu public național) și <b>unitățile administrativ-teritoriale — UAT</b> (județe, comune, orașe — domeniu public local). ⚠️ Persoanele private NU pot deține bunuri proprietate publică.',
          '<b>Bunurile proprietății publice</b> (art. 859 NCC): bogățiile de interes public ale subsolului, spațiul aerian, apele cu potențial energetic valorificabil de interes național, plajele, marea teritorială, resursele naturale ale zonei economice exclusive, alte bunuri stabilite prin lege. Enumerarea e exemplificativă; criteriul esențial = <b>interesul public</b>.',
          '<b>Tripla limitare</b> (art. 861 NCC): bunurile proprietate publică sunt <b>inalienabile</b> (nu se vând, donează, schimbă), <b>insesizabile</b> (nu pot fi urmărite silit, nu se pot constitui garanții reale asupra lor) și <b>imprescriptibile</b> (nu pot fi dobândite prin uzucapiune și revendicarea lor e imprescriptibilă). ⚠️ Capcană frecventă: nu se poate constitui ipotecă sau gaj pe un bun proprietate publică.',
          '<b>Modalitățile de exercitare</b> (art. 867–875 NCC): (1) <b>darea în administrare</b> — regiei autonome sau autorității publice (drept real, opozabil terților, revocabil de titular); (2) <b>concesionarea</b> — oricărei persoane (drept real; concesionarul plătește redevență; nu poate ceda dreptul, dar poate subcontracta); (3) <b>darea în folosință gratuită</b> — instituțiilor de utilitate publică (fără redevență); (4) <b>închirierea</b> — oricărei persoane (drept de creanță, nu drept real).',
          '<b>Trecerea bunurilor</b>: din domeniu public în domeniu privat → prin <b>hotărâre de Guvern</b> (domeniu național) sau <b>hotărâre a consiliului local/județean</b> (domeniu local), dacă bunul nu mai este de uz sau interes public; trecerea inversă (privat → public) = prin același mecanism sau prin expropriere.',
          '⚠️ <b>Capcane esențiale</b>: (a) bunurile publice NU se pot dobândi prin uzucapiune — posesia oricât de îndelungată e ineficace; (b) acțiunea în revendicare a bunurilor publice e <b>imprescriptibilă</b>; (c) contractele de concesiune sunt acte administrative, supuse Legii 100/2016 (nu dreptului civil pur); (d) statul poate acționa și ca titular al proprietății private (domeniu privat al statului) — acele bunuri urmează regimul dreptului privat comun.'
        ]
      }
    ],
...

  {
    ...
    sections:[
      { icon:'🌿', title:'Uzufructul (art. 703–748 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q15]</b> Dreptul de uzufruct <span style="color:var(--sub);font-size:0.9em">a) se poate dobândi prin testament · b) spre deosebire de dreptul de uz și de dreptul de abitație, este cesibil și viager · c) se stinge prin neuz timp de 5 ani</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">uzufructul se poate constitui prin act juridic – deci și prin testament – potrivit art. 704 alin. (1) C.civ. b) greșită: uzufructu…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'✋', title:'Posesia (art. 916–952 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q12]</b> Posesia <span style="color:var(--sub);font-size:0.9em">a) viciată nu produce niciun efect juridic · b) poate avea ca obiect bunuri corporale care fac parte dintr-o succesiune · c) încetează atunci când exercitarea elementului material se face prin intermediul altei persoane (corpore alieno)</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 916 C.civ., posesia este exercitarea în fapt a prerogativelor dreptului de proprietate asupra unui bun corporal; bun…</span>',
          '📌 <b>[Iul 2026 · G1 · Q17]</b> Uzucapiunea tabulară presupune <span style="color:var(--sub);font-size:0.9em">a) o durată a posesiei de 10 ani · b) o posesie de bună-credință până la momentul introducerii cererii de chemare în judecată de către adevăratul proprietar · c) un drept real principal înscris, fără cauză legitimă, în cartea funciară</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 931 C.civ., uzucapiunea tabulară privește dreptul real principal înscris fără cauză legitimă în cartea funciară, dob…</span>'
        ]
      },
      ...
      { icon:'📒', title:'Cartea funciară — principii, înscrieri, acțiunea în rectificare (art. 876–915 NCC)',
        items:[
          '<b>Principiul publicității reale</b> (art. 876 NCC): CF evidențiază drepturile reale imobiliare, sarcinile și faptele juridice privitoare la un imobil. Publicitate reală (pe imobil, nu pe proprietar) ≠ publicitate personală.',
          '<b>Efectul constitutiv al înscrierii</b> (art. 885 NCC): sub NCC, drepturile reale imobiliare se <b>dobândesc, modifică, grevează și sting numai prin înscrierea în CF</b>. Simpla convenție tranferă proprietatea <i>inter partes</i>, dar față de terți dreptul există numai de la <b>data înscrierii</b>. ⚠️ Excepții (art. 887 NCC): drepturi dobândite prin <b>succesiune, accesiune, vânzare silită, uzucapiune, expropriere, hotărâre judecătorească constitutivă</b> — se dobândesc fără înscriere, dar <b>titularul nu poate dispune de drept și nu îl poate opune terților</b> până la înscrierea în CF.',
          '<b>Structura CF</b>: Titlul (nr. CF + UAT) + <b>Partea I</b> — imobilul (descriere, suprafață, categorie de folosință) + <b>Partea II</b> — dreptul de proprietate (titulari, cote, mod de dobândire) + <b>Partea III</b> — sarcini (ipoteci, privilegii, servituți negative, drepturi de superficie, uzufruct, uz, abitație).',
          '<b>Tipuri de înscrieri</b>: (1) <b>Intabularea</b> — înscrierea <b>definitivă</b> a drepturilor reale; (2) <b>Înscrierea provizorie</b> — sub condiție sau cu titlu care nu e definitiv (ex: hotărâre nefinală, drept afectat de o condiție); (3) <b>Notarea</b> — drepturi personale, acțiuni judiciare, starea civilă, interdicții (ex: notarea acțiunii în rectificare, somaţia de plată, clauza de inalienabilitate).',
          '<b>Principiul publicității materiale — dobânditorul de bună-credință</b> (art. 901 NCC): cel care, cu <b>bună-credință</b>, dobândește cu <b>titlu oneros</b> un drept real imobiliar de la o persoană înscrisă în CF, este <b>protejat</b>, chiar dacă înstrăinătorul nu era adevăratul titular — dacă la data dobândirii nu era notată nicio acțiune prin care s-ar putea contesta înscrisul. ⚠️ Protecția operează după <b>3 ani</b> de la data înscrierii dreptului dobânditorului (uzucapiunea tabulară, art. 931 NCC). Înainte de 3 ani → dobânditorul poate fi evins dacă există vicii.',
          '<b>Acțiunea în rectificare</b> (art. 908–915 NCC): desființarea sau îndreptarea unei înscrieri necorespunzătoare realității. Motive (art. 908): înscrierea nu corespunde cu titlul pe care s-a întemeiat; după înregistrare, titlul a fost desființat retroactiv; prin înregistrare s-a adus atingere drepturilor altora. ⚠️ <b>Prescripție</b>: față de terțul dobânditor de <b>rea-credință</b> — <b>imprescriptibilă</b>; față de terțul de <b>bună-credință</b> care a dobândit cu titlu oneros — se prescrie în <b>3 ani de la data înscrierii dreptului acestuia</b> (art. 909 alin. 3). Notarea acțiunii în CF „îngheață" protecția terților ulteriori.',
          '<b>Prezumțiile CF</b> (art. 900 NCC): (1) dacă un drept e înscris în CF, se prezumă că există față de orice persoană; (2) dacă un drept a fost radiat, se prezumă că nu există. Prezumții relative (iuris tantum) — pot fi răsturnate prin acțiunea în rectificare.'
        ]
      }
    ],
...

  {
    ...
    sections:[
      { icon:'📌', title:'Condiții generale (art. 1349 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q19]</b> Paznicul juridic <span style="color:var(--sub);font-size:0.9em">a) se poate exonera prin invocarea unui eveniment fortuit, cum ar fi forța majoră, fapta victimei și fapta unui terț, dacă acestea din urmă îndeplinesc condițiile forței majore sau cazului fortuit · b) are un drept de regres împotriva paznicului material în condițiile recunoscute de lege pentru cel care răspunde pentru fapta altuia · c) poate avea această calitate în baza legii, a unui contract sau a unui fapt juridic</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">paza juridică (art. 1377 C.civ.) aparține celui care exercită controlul și supravegherea lucrului în temeiul legii, al unui contra…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'🔍', title:'Interpretarea contractului (art. 1266–1269 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q18]</b> Rezoluțiunea unilaterală a contractului <span style="color:var(--sub);font-size:0.9em">a) poate opera și pe cale judiciară · b) poate fi declarată și de creditorul care a cauzat prin inacțiunea sa neexecutarea obligației · c) nu înlătură dreptul creditorului de a obține daune-interese în condițiile legii</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1549 și art. 1554 alin. 3 C.civ., rezoluțiunea (inclusiv cea unilaterală) nu înlătură dreptul creditorului la daune-…</span>',
          '📌 <b>[Iul 2026 · G1 · Q21]</b> Obligația de a da o sumă de bani <span style="color:var(--sub);font-size:0.9em">a) asumată de o pluralitate de debitori poate fi indivizibilă, prin convenția părților · b) poate fi executată în natură sau prin echivalent · c) neexecutată la termen dă creditorului dreptul la daune-interese moratorii de la data punerii în întârziere a debitorului până la data plății</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1425 C.civ., indivizibilitatea poate rezulta din convenția părților, deci o obligație bănească (divizibilă prin natu…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'↔️', title:'Cesiunea de creanță, preluarea datoriei, cesiunea de contract',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q22]</b> Compensația <span style="color:var(--sub);font-size:0.9em">a) între un codebitor solidar și creditor stinge în integralitate obligația solidară, dacă datoria creditorului are o valoare mai mare decât datoria ce face obiectul obligației solidare · b) nu poate fi opusă de către autorul furtului adevăratului proprietar, ca mod de stingere a obligației de a restitui bunurile furate · c) judiciară, spre deosebire de cea convențională, poate avea loc și dacă obiectul obligației părților privește prestarea unui serviciu</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">conform art. 1618 lit. a) C.civ., compensația nu are loc când datoria rezultă dintr-un act făcut cu intenția de a păgubi; hoțul nu…</span>',
          '📌 <b>[Iul 2026 · G1 · Q23]</b> Cesiunea de creanță <span style="color:var(--sub);font-size:0.9em">a) spre deosebire de preluarea de datorie realizată prin contract încheiat între creditor și noul debitor, nu presupune pentru încheierea valabilă a actului juridic, ca regulă, consimțământul debitorului din raportul juridic obligațional inițial · b) poate fi făcută opozabilă debitorului cedat și prin comunicarea acesteia odată cu cererea de chemare în judecată formulată de creditorul cesionar · c) are ca efect transmiterea drepturilor de garanție accesorii creanței cedate doar dacă acest lucru s-a prevăzut expres în contractul de cesiune. 2 ATEA-DE-DILED. CERCETARI SAVERSITAPE</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1578 alin. (1) lit. b) și art. 1580 C.civ., cesiunea poate fi comunicată debitorului cedat odată cu cererea de chema…</span>'
        ]
      },
      ...
      { icon:'↩️', title:'Restituirea prestațiilor (art. 1635–1649 NCC)',
        items:[
          '<b>Domeniu de aplicare</b> (art. 1635 NCC): ori de câte ori o persoană e ținută să restituie bunuri sau valori primite fără drept ori din eroare, sau ca urmare a unui act juridic desființat ulterior (nulitate, rezoluțiune, reziliere, caducitate, revocare, îndeplinirea condiției rezolutorii etc.).',
          '<b>Restituirea în natură</b> (art. 1639 NCC): regula — restituirea bunului primit. Dacă bunul a pierit ori a fost înstrăinat, restituirea se face <b>prin echivalent</b> (art. 1640 NCC): debitorul de bună-credință restituie valoarea cea mai <b>mică</b> dintre valoarea de la data primirii și valoarea de la data restituirii; debitorul de <b>rea-credință</b> restituie valoarea cea mai <b>mare</b> (art. 1641).',
          '<b>Fructele</b> (art. 1645 NCC): primitorul de bună-credință restituie numai fructele existente la data cererii de restituire; primitorul de <b>rea-credință</b> restituie toate fructele culese pe toată perioada deținerii. ⚠️ Posesorul de bună-credință care culege fructele naturale/industriale înainte de cerere le păstrează (art. 948 NCC — confirmat și în contextul restituirii).',
          '<b>Cheltuielile</b> (art. 1644 NCC): cel obligat la restituire are dreptul să recupereze <b>cheltuielile necesare</b> (conservare) integral și <b>cheltuielile utile</b> în limita sporului de valoare adus bunului. Cheltuielile voluptuare (de plăcere) nu se recuperează.',
          '⚠️ <b>Principiul „nemo auditur" sub NCC — CAPCANĂ</b>: sub vechiul cod, prestația executată în temeiul unei cauze imorale/ilicite NU se restituia (<i>in pari causa turpitudinis melior est conditio possidentis</i>). Sub NCC, art. 1638 prevede că prestația executată în temeiul unei cauze imorale sau ilicite rămâne <b>nerambursată</b> numai dacă ambele părți sunt <b>deopotrivă culpabile</b>; dacă numai una e culpabilă, cealaltă poate obține restituirea. ⚠️ Regula sub NCC este RESTITUIREA; excepția e nerambursarea la culpă egală — invers față de impresia lasată de cursuri bazate pe vechiul cod!',
          '<b>Restituirea la nulitate</b> (art. 1254 NCC): desființarea retroactivă (ex tunc) a contractului nul → fiecare parte restituie celeilalte prestațiile primite. Restituirea e obligatorie chiar dacă actul era imoral, cu excepția de la art. 1638. Minorul care și-a ascuns vârsta (rea-credință) NU poate invoca nulitatea relativă pentru a refuza restituirea (art. 1647 NCC).'
        ]
      }
    ],
...

  {
    ...
    sections:[
      { icon:'🛒', title:'Contractul de vânzare-cumpărare — esențiale (art. 1650–1762 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q6]</b> În cazul incapacității speciale de folosință a persoanei fizice <span style="color:var(--sub);font-size:0.9em">a) persoana afectată de incapacitate nu poate încheia actul personal și acționând singură, dar îl poate încheia valabil prin reprezentant sau cu încuviințare, ori, după caz, cu autorizare prealabilă · b) persoana afectată de incapacitate nu poate încheia valabil actul nici personal și nici acționând cu încuviințare sau autorizare prealabilă · c) încheierea actului cu încălcarea unei incapacități absolute atrage întotdeauna nulitatea absolută a acelui act</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">incapacitatea de folosință înseamnă lipsa aptitudinii de a avea dreptul însuși (art. 34, 206 C.civ.; ex. art. 1653-1654 C.civ.), d…</span>',
          '📌 <b>[Iul 2026 · G1 · Q24]</b> A îi vinde lui B un utilaj industrial cu plata prețului în rate, obligația de plată fii… <span style="color:var(--sub);font-size:0.9em">a) B rămâne obligat la plata ratelor rămase · b) B este liberat de plata ratelor rămase, întrucât, riscul pieirii fortuite rămâne în sarcina vânzătorului, ca proprietar (res perit domino) · c) riscul se suportă în mod egal de ambele părți, proporțional cu ratele deja achitate și, respectiv, cu cele rămase neachitate</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">art. 1755 C.civ. prevede că, în vânzarea cu plata prețului în rate și rezerva proprietății, riscul bunului este transferat cumpără…</span>',
          '📌 <b>[Iul 2026 · G1 · Q25]</b> B cumpără de la A un echipament, pe care îl folosește potrivit destinației sale. La scu… <span style="color:var(--sub);font-size:0.9em">a) instanța nu poate acorda decât remediul ales de cumpărător, întrucât, potrivit dreptului comun, alegerea mijlocului de remediere a neexecutării aparține creditorului obligației neexecutate · b) la cererea vânzătorului, instanța poate dispune o altă măsură decât rezoluțiunea solicitată de cumpărător, ținând seama de gravitatea viciilor și de scopul pentru care contractul a fost încheiat, precum și de alte împrejurări · c) instanța poate înlocui remediul ales de cumpărător numai dacă acesta din urmă consimte la aceasta</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">art. 1710 alin. (2) C.civ. permite instanței ca, la cererea vânzătorului, ținând seama de gravitatea viciilor și de scopul pentru…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'🏠', title:'Locațiunea (art. 1777–1850 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q11]</b> În cazul încheierii, în numele persoanei juridice, a unui contract pentru care legea ce… <span style="color:var(--sub);font-size:0.9em">a) contractul este valabil numai dacă persona juridică este reprezentată de către organul său de conducere · b) organul de administrare al persoanei juridice poate să reprezinte valabil persona juridică, chiar fără a avea o procură specială care să îmbrace forma autentică · c) dacă reprezentantul legal își depășește puterile de reprezentare fixate prin actele constitutive regulat publicate, contractul nu va fi al persoanei juridice, chiar dacă cealaltă parte contractantă nu a cunoscut efectiv această neregularitate</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">organul de administrare este reprezentant legal al persoanei juridice (art. 209 C.civ.), iar cerința simetriei formei procurii (ar…</span>',
          '📌 <b>[Iul 2026 · G1 · Q26]</b> Prin contractul de locațiune având ca obiect un garaj, părțile au inserat o clauză prin… <span style="color:var(--sub);font-size:0.9em">a) sublocațiunea parțială este permisă · b) sublocațiunea este interzisă, întrucât interdicția de a ceda locațiunea o include și pe aceea de a subînchiria, fie și parțial · c) sublocațiunea este întotdeauna supusă încuviințării scrise al locatorului</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1806 alin. (1) C.civ., interdicția de a ceda locațiunea nu o include pe aceea de a încheia o sublocațiune; cum părți…</span>',
          '📌 <b>[Iul 2026 · G1 · Q27]</b> A îl însărcinează pe B să cumpere pe seama lui A, dar în numele lui B, un tablou expus … <span style="color:var(--sub);font-size:0.9em">a) T îl poate acționa direct pe A pentru plata prețului, întrucât A este adevăratul cumpărător · b) vânzarea este încheiată între B și T, drept care T nu se poate întemeia pe vânzare pentru a pretinde plata prețului de la A · c) A poate pretinde în toate cazurile executarea obligației de predare a bunului de către T</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">în mandatul fără reprezentare, mandatarul contractează în nume propriu, iar potrivit art. 2040 alin. (1) C.civ. terții nu au niciu…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'💰', title:'Împrumutul de consumație — mutuum (art. 2158–2170 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q29]</b> A îi împrumută cu titlu gratuit lui B un autoturism, pentru o durată determinată. Pe pa… <span style="color:var(--sub);font-size:0.9em">a) A nu datorează cheltuielile curente de folosință, pe care comodatarul le suportă, însă datorează cheltuielile pentru lucrările necesare, neprevăzute și urgente, efectuate fără posibilitatea înștiințării prealabile · b) A datorează rambursarea tuturor cheltuielilor făcute de B în legătură cu bunul · c) A nu datorează nicio cheltuială</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">Conform art. 2151 alin. (1) C.civ., comodatarul suportă cheltuielile pe care le-a făcut pentru a folosi bunul (combustibil, întreț…</span>',
          '📌 <b>[Iul 2026 · G1 · Q30]</b> A i-a transmis lui B, prin contract de întreținere încheiat în formă autentică, nuda pr… <span style="color:var(--sub);font-size:0.9em">a) dacă A solicită rezoluțiunea, cererea sa va fi admisă, întrucât imposibilitatea de executare a obligației de întreținere este prin ipoteză gravă și atrage desființarea contractului · b) întrucât imposibilitatea continuării întreținerii în natură provine din motive obiective, instanța poate, la cererea oricăreia dintre părți, să înlocuiască întreținerea în natură cu o sumă de bani corespunzătoare, fie și numai temporar · c) contractul încetează de drept, iar debitorul, restituind nuda proprietate, are dreptul la restituirea integrală a prestațiilor de întreținere deja executate. 3 1-DE-DILET CERCE</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">Potrivit art. 2261 alin. (1) C.civ., dacă prestarea sau primirea în natură a întreținerii nu mai poate continua din motive obiecti…</span>'
        ]
      },
      ...
      { icon:'🤲', title:'Contractul de întreținere (art. 2254–2263 NCC)',
        items:[
          '<b>Definiție</b> (art. 2254 NCC): creditorul înstrăinează un bun sau constituie o rentă ori face altă prestație în favoarea debitorului, iar debitorul se obligă să asigure creditorului <b>întreținere în natură</b> pe durata vieții acestuia: locuință, hrană, îmbrăcăminte, îngrijire medicală și orice alte necesități ale vieții.',
          '<b>Caractere juridice</b>: (1) <b>oneros</b>; (2) <b>aleatoriu</b> — durata obligației e incertă (depinde de viața creditorului); (3) <b>sinalagmatic</b>; (4) <b>intuitu personae</b> — obligația de întreținere se naște în considerarea persoanei creditorului și nu poate fi cedată fără acordul acestuia. ⚠️ <b>Formă solemnă</b> (art. 2255 NCC): se încheie în <b>formă autentică</b> (<i>ad validitatem</i>); lipsa formei autentice → nulitate absolută.',
          '⚠️ <b>Distincție față de renta viageră</b> (art. 2242 NCC): renta viageră = prestație periodică în <b>bani</b>; contractul de întreținere = prestație în <b>natură</b> (îngrijire personală). Ambele sunt aleatorii și intuitu personae, dar forma și conținutul diferă. ⚠️ La contractul de întreținere nu există noțiunea de „rentă" — dacă plata e bănească, e rentă viageră, nu întreținere.',
...

  {
    ...
    sections:[
      { icon:'🔄', title:'Transmisiunea moștenirii — caractere juridice (art. 953–956 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q31]</b> Față de moștenirea lui D, reclamă drepturi fiul său, F2, și nepotul de fiu al defunctul… <span style="color:var(--sub);font-size:0.9em">a) N nu poate veni prin reprezentare, întrucât nu este posibilă reprezentarea renunțătorului · b) N poate veni la moștenire prin reprezentarea tatălui său nedemn · c) N nu poate veni prin reprezentare, dar culege moștenirea în nume propriu, în concurs cu F2, fiecare câte o jumătate</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">Potrivit art. 967 alin. (1) C.civ., poate fi reprezentată persoana lipsită de capacitatea de a moșteni, precum și nedemnul, chiar…</span>',
          '📌 <b>[Iul 2026 · G1 · Q32]</b> D decedează, lăsând ca moștenitori pe soția supraviețuitoare, S, pe fiul său, F, precum… <span style="color:var(--sub);font-size:0.9em">a) S culege 1/4 din moștenire; restul de 3/4 se împarte pe tulpini între descendenți, astfel încât F culege 3/8, iar N1 și N2 câte 3/16 fiecare · b) S culege 1/4 din moștenire, iar restul se împarte pe capete, în mod egal, între F, N1 și N2, fiecare culegând câte 1/4 din moștenire · c) S culege 1/3 din moștenire, iar restul de 2/3 se împarte pe tulpini între F și tulpina fiicei predecedate</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">Potrivit art. 975 alin. (3) C.civ., soțul supraviețuitor în concurs cu descendenții culege 1/4 din moștenire. Restul de 3/4 revine…</span>',
          '📌 <b>[Iul 2026 · G1 · Q35]</b> S, succesibil al defunctului D, a dat o declarație autentică de renunțare la moștenire.… <span style="color:var(--sub);font-size:0.9em">a) S rămâne renunțător, sustragerea atrăgând numai obligația de a restitui bunul și, eventual, de a plăti daune-interese · b) S este considerat că a acceptat moștenirea, chiar dacă anterior renunțase, însă nu va avea niciun drept cu privire la bunul sustras · c) S este decăzut din dreptul de opțiune și devine cu desăvârșire străin de moștenire, ca și cum nu ar fi fost niciodată chemat la aceasta</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1119 alin. (1) C.civ., succesibilul care, cu rea-credință, a sustras ori a ascuns bunuri din patrimoniul succesoral…</span>'
        ]
      },
      ...
      { icon:'✂️', title:'Partajul succesoral și raportul donațiilor (art. 1143–1165 NCC)',
        items:[
          '<b>Definiție</b>: partajul succesoral = operațiunea juridică prin care se pune capăt <b>stării de indiviziune</b> a moștenirii, fiecare coindivizar dobândind bunuri proprii în locul cotei-parts indivize.',
          '<b>Efectul constitutiv</b> (art. 680 NCC): ⚠️ sub NCC, partajul are efect <b>constitutiv</b>, nu declarativ — fiecare coindivizar devine proprietar exclusiv al bunurilor atribuite <b>de la data partajului</b> (nu retroactiv de la deschiderea moștenirii). La imobile: de la data înscrierii în CF. Capcana: sub vechiul cod partajul era declarativ (efecte retroactive) — grilele testează exact această schimbare!',
          '<b>Felurile partajului</b>: (1) <b>voluntar (amiabil)</b> — prin acordul <b>tuturor</b> coindivizarilor; dacă printre ei sunt incapabili sau minori → necesită asistarea/reprezentarea legală + aprobarea instanței de tutelă. (2) <b>judiciar</b> — la cererea oricărui coindivizar, dacă nu se înțeleg. Instanța formează loturile (prin expertiză), le atribuie și, dacă loturile nu sunt egale, stabilește <b>sume de egalizare (sulte)</b>.',
          '<b>Partajul parțial</b> (art. 669 alin. 2 NCC): se poate partaja numai o parte din bunuri, restul rămânând în indiviziune. Dreptul la partaj e <b>imprescriptibil</b> — poate fi cerut oricând, indiferent de durata indiviziunii.',
          '<b>Raportul donațiilor</b> (art. 1146–1165 NCC): obligația moștenitorului <b>descendent sau soț supraviețuitor</b> care a primit o donație de la defunct, de a readuce acea donație la masa succesorală <b>înainte de împărțire</b>, pentru a restabili egalitatea între comoștenitori. ⚠️ Condiții cumulative: (a) moștenitorul a acceptat succesiunea; (b) donația nu a fost scutită de raport de dispunător; (c) donatarul era descendent sau soț supraviețuitor la data donației.',
          '<b>Raportul ≠ reducțiunea</b>: raportul se face la cererea celorlalți comoștenitori și urmărește egalitatea; reducțiunea se face la cererea rezervatarilor și urmărește protejarea rezervei. Pot opera simultan (o donație poate fi atât supusă raportului, cât și reducțiunii, dacă depășește cotitatea disponibilă).',
          '<b>Moduri de raport</b> (art. 1151 NCC): (1) <b>prin echivalent</b> — donatarul impută valoarea donației asupra cotei sale și primește mai puțin la partaj (preferabil); (2) <b>în natură</b> — bunul donat se aduce efectiv la masa succesorală (posibil numai dacă bunul există și nu a fost înstrăinat). Valoarea de raportat: valoarea bunului <b>la data raportului</b> (nu la data donației — capcana!).'
        ]
      }
    ],
...

  {
    ...
    sections:[
      { icon:'📜', title:'Testamentul — forme și revocare (art. 1034–1085 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q33]</b> La decesul lui D vin la moștenire soția sa supraviețuitoare, S, și doi copii ai defunct… <span style="color:var(--sub);font-size:0.9em">a) liberalitatea rămâne pe deplin eficace în măsura în care este cel mult egală cu ½ din moștenire · b) liberalitatea făcută în favoarea lui S nu poate depăși un sfert din moștenire și nici partea descendentului care a primit cel mai puțin · c) liberalitatea nu este susceptibilă de reducțiune, întrucât soțul supraviețuitor are calitatea de moştenitor rezervatar</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 1090 alin. (1) C.civ., liberalitățile neraportabile făcute soțului supraviețuitor care vine la moștenire în concurs…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'📌', title:'Definiție, trăsături esențiale și legalitate (art. 1, 15 NCP)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q51]</b> Alegeți afirmația corectă <span style="color:var(--sub);font-size:0.9em">a) Atât în cazul intenției indirecte cât și în cazul culpei cu prevedere făptuitorul acceptă producerea rezultatului faptei sale · b) Spre deosebire de intenția directă, în cazul culpei simple făptuitorul nu prevede rezultatul faptei sale · c) Atât în cazul intenției directe cât și în cazul culpei cu prevedere, făptuitorul nu prevede rezultatul faptei sale.</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 16 alin. (4) lit. b) CP, în cazul culpei simple (neglijenței) făptuitorul nu prevede rezultatul faptei, deși trebuia…</span>',
          '📌 <b>[Iul 2026 · G2 · Q63]</b> In cazul liberării condiționate, instanța face aplicarea dispozițiilor de la concurs, r… <span style="color:var(--sub);font-size:0.9em">a) numai în cazul anulării măsurii respective · b) atât în cazul revocării cât si al anulării măsurii liberării condiționate · c) numai în cazul revocării acelei măsuri</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 105 alin. (1) C. pen., anularea liberării condiționate (când se descoperă o infracțiune săvârșită înainte de acordar…</span>',
          '📌 <b>[Iul 2026 · G3 · Q64]</b> În cauză inculpatul a fost condamnat la 2 ani închisoare pentru o infracțiune de furt c… <span style="color:var(--sub);font-size:0.9em">a) sunt realizate condițiile recidivei postcondamnatorii, iar inculpatului urmează să i se aplice pedeapsa rezultantă de 3 ani și 3 luni · b) sunt realizate condițiile recidivei postcondamnatorii, iar inculpatul va fi condamnat la 3 ani și 5 luni închisoare din care se va scădea pedeapsa de 1 an executată deja · c) nu sunt realizate condițiile unei recidive deoarece anterior condamnatul executase pedeapsa de doar 1</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">primul termen al recidivei postcondamnatorii există (art. 41 C.pen.): condamnare de 1 an și 3 luni (peste 1 an), neexecutată integ…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'⚖️', title:'Principiile răspunderii penale (art. 1–6 NCP)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q59]</b> Pedepsele complementare constând în interzicerea exercitării unor drepturi, stabilite p… <span style="color:var(--sub);font-size:0.9em">a) toate dacă sunt de aceeași natură și cu același conținut · b) toate dacă sunt de aceeași natură, dar cu un conținut diferit · c) numai dacă au fost stabilite pe lângă pedeapsa cea mai grea</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">conform art. 45 alin. (2) C.pen., când s-au stabilit mai multe pedepse complementare de natură diferită sau de aceeași natură, dar…</span>',
          '📌 <b>[Iul 2026 · G1 · Q61]</b> În cazul persoanei juridice <span style="color:var(--sub);font-size:0.9em">a) dacă după o condamnare definitivă și mai înainte de executarea acesteia se săvârșește din nou o infracțiune în condițiile recidivei, se va stabili o pedeapsă între limitele prevăzute de lege majorate cu jumătate și aceasta se va adăuga la restul rămas neexecutat din condamnarea anterioară · b) dacă termenul de prescripție a răspunderii penale a fost depășit cu încă jumătate va fi considerat îndeplinit oricâte întreruperi ar interveni · c) pedepsele cu amenda stabilite pentru infracțiunile concurente se contopesc prin aplicarea pedepsei celei mai grele la care se va adăuga un spor de o pătrime din totalul celorlalte pedepse</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">în caz de recidivă a persoanei juridice, limitele speciale ale pedepsei pentru noua infracțiune se majorează cu jumătate (art. 146…</span>',
          '📌 <b>[Iul 2026 · G1 · Q62]</b> Spre deosebire de amânarea aplicării pedepsei, în cazul suspendării executării pedepsei… <span style="color:var(--sub);font-size:0.9em">a) nu există o condiție referitoare la maximul special prevăzut de lege pentru infracțiunea săvârșită · b) nu se va executa pedeapsa amenzii stabilită pentru săvârșirea uneia dintre infracțiunile concurente deduse judecății · c) va putea fi dispusă dacă pentru o condamnare anterioară a intervenit reabilitarea de drept</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">amânarea aplicării pedepsei cere ca pedeapsa prevăzută de lege să fie mai mică de 7 ani (art. 83 alin. 2 C.pen.), pe când suspenda…</span>'
        ]
      },
      ...
      { icon:'🕊️', title:'Amnistia, grațierea, plângerea prealabilă și împăcarea (art. 152–159 NCP)',
        items:[
          '<b>Amnistia</b> (art. 152): înlătură <b>răspunderea penală</b> pentru fapta comisă; intervenită <b>după condamnare</b> → înlătură și executarea pedepsei + celelalte consecințe. ⚠️ NU produce efecte asupra <b>măsurilor de siguranță</b> și a <b>drepturilor persoanei vătămate</b> (despăgubirile civile rămân!). Amenda deja plătită NU se restituie.',
          '<b>Grațierea</b> (art. 160): înlătură, total sau parțial, <b>executarea pedepsei</b> (nu răspunderea — condamnarea rămâne în cazier, poate fi prim termen al recidivei!). Individuală (decret prezidențial) sau <b>colectivă</b> (lege organică). ⚠️ NU are efect asupra: pedepselor <b>complementare</b> (dacă nu se prevede expres), <b>măsurilor de siguranță</b>, măsurilor educative neprivative, drepturilor persoanei vătămate.',
          '⚠️ <b>La grilă — amnistie vs. grațiere</b>: amnistia șterge răspunderea (fapta „dispare" penal); grațierea iartă doar executarea — condamnarea subzistă. Grațierea condiționată: comiterea unei noi infracțiuni în termen → execută și pedeapsa grațiată (cumul).',
          '<b>Lipsa/retragerea plângerii prealabile</b> (art. 157–158): retragerea — până la <b>hotărârea definitivă</b>, doar la infracțiunile urmăribile la plângere; e <b>indivizibilă obiectiv</b>... ⚠️ dar trebuie făcută <b>față de fiecare făptuitor</b> (in personam sub NCP — capcană!). La faptele urmărite din oficiu după plângere → retragerea nu mai produce efecte.',
          '<b>Împăcarea</b> (art. 159): numai unde legea o prevede <b>expres</b> (furt simplu/unele forme, înșelăciune, abuz de încredere...); e <b>personală</b>, definitivă, totală (penal + civil) și poate interveni doar <b>până la citirea actului de sesizare</b> — spre deosebire de retragerea plângerii (până la hotărârea definitivă)! Distincție de top la grile.'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'⚰️', title:'Infracțiuni contra vieții (art. 188–195 NCP)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q69]</b> X a lovit victima cu o bâtă și cu picioarele de mai multe ori în zona capului și a abdo… <span style="color:var(--sub);font-size:0.9em">a) tentativă la infracțiunea de omor · b) infracțiunea de vătămare corporală · c) infracțiunea de loviri sau alte violențe</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">lovirea repetată cu bâta și picioarele în zone vitale (cap), cu intensitate care a dus la extirparea splinei și punerea în primejd…</span>',
          '📌 <b>[Iul 2026 · G3 · Q71]</b> X a lovit victima cu o bâtä și cu picioarele de mai multe ori în zona capului și a abdo… <span style="color:var(--sub);font-size:0.9em">a) tentativă la infracțiunea de omor · b) infracțiunea de vătămare corporală · c) infracțiunea de loviri sau alte violențe</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">lovirea repetată cu bâta și picioarele în zone vitale (cap, abdomen), cu consecința extirpării splinei și punerii în primejdie a v…</span>',
          '📌 <b>[Iul 2026 · G1 · Q71]</b> După ce sustrage bunuri din locuința lui A, X este surprins de V, un trecător. Pentru a… <span style="color:var(--sub);font-size:0.9em">a) tâlhărie urmată de moartea victimei · b) un concurs între infracțiunile de furt și omor calificat săvârșit pentru a înlesni sau a ascunde săvârșirea altei infracțiuni · c) un concurs între infracțiunile de tâlhărie și omor calificat săvârșit pentru a înlesni sau a ascunde săvârșirea altei infracțiuni</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">furtul urmat de violențe pentru asigurarea scăpării constituie tâlhărie (art. 233 C.pen. — ipoteza furtului urmat de întrebuințare…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'💰', title:'Infracțiuni contra patrimoniului — forme principale (art. 228–256 NCP)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q72]</b> X îi administrează lui V, fără știrea acestuia, un somnifer puternic în băutură, V bea … <span style="color:var(--sub);font-size:0.9em">a) furt calificat · b) tâlhărie · c) furt</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">art. 233 C.pen. include în tâlhărie furtul săvârșit prin punerea victimei în stare de inconștiență sau neputință de a se apăra. Ad…</span>',
          '📌 <b>[Iul 2026 · G1 · Q75]</b> X și Y se întâlnesc pentru prima oară la un bar. La finalul serii, având în vedere că c… <span style="color:var(--sub);font-size:0.9em">a) îi sustrage lui Y telefonul în incinta taxiului fără ca Y să-și dea seama, în sarcina lui X se va reține infracțiunea de furt calificat săvârșit într-un mijloc de transport în comun · b) îi sustrage lui Y telefonul în incinta taxiului prin adresarea de amenințări, în sarcina lui X se va reține infracțiunea de tâlhărie calificată (comisă într-un mijloc de transport sau asupra unui mijloc de transport) · c) își însușește telefonul uitat de Y în taxi, împrejurare observată de X, în sarcina lui se va reține infracțiunea de însușire a bunului găsit</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">tâlhăria calificată de la art. 234 alin. (1) lit. b) C.pen. se reține când fapta e comisă într-un mijloc de transport sau asupra u…</span>',
          '📌 <b>[Iul 2026 · G1 · Q77]</b> Asupra unui autovehicul s-a aplicat măsura asigurătorie a sechestrului. Care dintre urm… <span style="color:var(--sub);font-size:0.9em">a) dacă X este un terț care, cunoscând că respectivul autovehicul se află sub sechestru, sustrage bunul în scop de însușire, în sarcina lui se vor reține în concurs infracțiunile de sustragere de sub sechestru și furt · b) dacă X, custodele bunului sechestrat, dispune de respectivul autovehicul, în condițiile în care nu este și proprietar al bunului, în sarcina sa se vor reține în concurs infracțiunile de sustragere de sub sechestru și furt · c) dacă X este proprietarul bunului sechestrat și, cu scopul de a eluda măsura asigurătorie, vinde autovehiculul unui prieten, în sarcina lui X se vor reține în concurs infracțiunile de sustragere de sub sechestru și abuz de încredere</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">terțul care, cunoscând existența sechestrului, ia bunul în scop de însușire lezează două valori sociale distincte — patrimoniul (f…</span>'
        ]
      },
      ...
      { icon:'👨‍👩‍👧', title:'Infracțiuni contra familiei — Abandonul de familie (art. 378 NCP)',
        items:[
          '<b>Subiect activ calificat</b>: persoana care are o <b>obligație legală de întreținere</b> față de victimă (părinți față de copii minori, soți reciproc, copii majori față de părinți aflați în nevoie, alte relații legale de întreținere — art. 516–527 NCC).',
          '<b>Modalitățile faptei</b> (art. 378 alin. 1 NCP): (a) <b>abandonul propriu-zis</b>: <i>„părăsirea, alungarea sau lăsarea fără ajutor, expunând-o la suferințe fizice sau morale"</i> a persoanei față de care există obligația de întreținere; (b) <b>stabilirea de venituri fictive</b>: stabilirea cu rea-credință a unor condiții de muncă/sursă de venituri inferioare, pentru a se sustrage de la obligația de întreținere; (c) <b>neplata pensiei de întreținere</b>: cu rea-credință, <b>2 luni</b> consecutive (⚠️ — nu 3 luni, rectificat prin L. 217/2020).',
          '<b>Pedeapsa</b>: închisoare de la <b>6 luni la 3 ani</b> sau amendă. Acțiunea penală se pune în mișcare <b>la plângerea prealabilă</b> a persoanei vătămate (art. 378 alin. 4 NCP).',
          '<b>Cauza specială de nepedepsire</b> (art. 378 alin. 3 NCP): dacă, până la rămânerea definitivă a hotărârii, inculpatul <b>înlătură consecințele faptei</b> (achită toate restanțele de întreținere), instanța aplică <b>renunțarea la aplicarea pedepsei</b>. ⚠️ Cauza de nepedepsire nu stinge infracțiunea, ci doar scutește de pedeapsă (nu e o cauză de neimputabilitate sau justificativă).',
          '⚠️ <b>Distincții esențiale</b>: (a) abandonul de familie (art. 378) ≠ rele tratamente aplicate minorului (art. 197) — acesta din urmă vizează acte de violență/cruzime, nu simpla lipsă de întreținere; (b) subiectul activ trebuie să aibă obligația <b>legală</b> de întreținere (nu morală) — lipsa obligației legale → fapta nu e infracțiune. ⚠️ <b>Plângerea prealabilă</b>: e necesară; împăcarea înlătură răspunderea (art. 159 NCP — împăcarea se aplică la infracțiunile pentru care acțiunea penală se pune în mișcare la plângerea prealabilă, dacă legea nu prevede altfel).'
        ]
      }
    ],
...

  {
    ...
    sections:[
      { icon:'💼', title:'Infracțiuni de corupție (art. 289–294 NCP)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q80]</b> În cazul infracțiunii de luare de mită <span style="color:var(--sub);font-size:0.9em">a) persoana juridică nu poate răspunde în calitate de autor · b) persoana juridică nu poate răspunde în calitate de complice · c) persoana căreia i se pretind bani sau alte foloase nu poate fi și o persoană juridică</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">luarea de mită (art. 289 C.pen.) are subiect activ nemijlocit calificat — funcționarul public (art. 175 C.pen.) sau persoana prevă…</span>',
          '📌 <b>[Iul 2026 · G1 · Q81]</b> Infracțiunea de dare de mită se consumă <span style="color:var(--sub);font-size:0.9em">a) la momentul îndeplinirii, neîndeplinirii, urgentării ori întârzierii îndeplinirii unui act ce intră în îndatoririle de serviciu ale unui funcționar public sau la momentul îndeplinirii unui act contrar acestor îndatoriri · b) în ipoteza oferirii de bani sau alte foloase, întotdeauna în același timp cu consumarea infracțiunii de luare de mită · c) în ipoteza dării, în momentul remiterii efective a banilor sau foloaselor</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">darea de mită (art. 290 C.pen.) este o infracțiune de pericol, cu consumare instantanee la realizarea oricărei modalități alternat…</span>'
        ]
      },
      { icon:'🏛️', title:'Infracțiuni de serviciu (art. 295–309 NCP)',
        items:[
          ...
          '<b>Folosirea funcției pentru favorizarea unor persoane</b> (art. 301 NCP — fostul „conflict de interese", redenumit și restrâns în 2017): funcționarul public care a îndeplinit un act ori a participat la luarea unei decizii prin care s-a obținut un <b>folos patrimonial</b> pentru sine, soț, <b>rudă sau afin până la gradul II</b>. ⚠️ La grile vechi poate apărea sub numele „conflict de interese".',
      ...
      { icon:'⚖️', title:'Infracțiuni contra înfăptuirii justiției (art. 266–288 NCP)',
        items:[
          '<b>Inducerea în eroare a organelor judiciare</b> (art. 268 NCP — „denunțul calomnios" era denumirea vechiului cod): sesizarea mincinoasă cu privire la o faptă inexistentă sau la o persoană nevinovată; inclusiv producerea/ticluirea de probe nereale. ⚠️ Dacă autorul credea sincer că fapta există → lipsă de intenție, nu e infracțiune. Cauza de nepedepsire: declară, înainte de reținerea/arestarea persoanei ori de punerea în mișcare a acțiunii penale, că sesizarea e nereală.',
      ...
      { icon:'💰', title:'Spălarea banilor și evaziunea fiscală',
        items:[
          '<b>Spălarea banilor</b> (art. 49 Legea 129/2019, fostul art. 29 Legea 656/2002): (a) schimbarea sau transferul bunurilor, cunoscând proveniența infracțională, pentru ascunderea originii; (b) ascunderea sau disimularea naturii, originii, situării bunurilor; (c) dobândirea, deținerea sau folosirea bunurilor, cunoscând proveniența. Pedeapsă: <b>3–10 ani</b> (legea nouă a redus de la 3–12).',
          ...
          '<b>Auto-spălarea</b>: subiect activ al spălării poate fi <b>și autorul infracțiunii predicat</b>, dar numai pentru variantele de la lit. <b>a) și b)</b> (schimbare/transfer, ascundere/disimulare). ⚠️ <b>CCR 418/2018</b>: varianta de la lit. c) (dobândire/deținere/folosire) NU poate fi comisă de autorul infracțiunii predicat — ar fi o dublă incriminare a aceleiași conduite.',
          '<b>Evaziunea fiscală</b> (Legea 241/2005, art. 9): sustragerea de la plata obligațiilor fiscale prin: ascunderea bunului/sursei impozabile; documente false; evidențe duble; nedeclararea veniturilor etc. Pedeapsă: <b>2–8 ani</b>; prejudiciu peste <b>100.000 €</b> → limitele <b>+5 ani</b>; peste <b>500.000 €</b> → limitele <b>+7 ani</b> (deci 9–15).',
          '<b>Art. 10 L. 241/2005</b> (forma actuală, după L. 55/2021): dacă prejudiciul, <b>majorat cu 20% + dobânzi și penalități</b>, e acoperit integral până la primul termen de judecată → limitele pedepsei se <b>reduc la jumătate</b>; la prejudicii mici legea permite amenda sau chiar nepedepsirea. Acoperirea parțială = doar eventuală atenuantă.',
    ...
    grila:'Luare de mită = <b>funcționarul însuși</b> primește; trafic de influență = <b>oricine</b> pretinde că influențează funcționarul. Dare de mită sub constrângere → <b>nepedepsire</b>. Abuz în serviciu: numai prin nerespectarea <b>legii</b> (CCR 405/2016). Art. 301 = „folosirea funcției pentru favorizarea unor persoane" (fostul conflict de interese; rudă/afin gradul II). Art. 268 = „inducerea în eroare a organelor judiciare" (fostul denunț calomnios). Mărturie mincinoasă: retractare înainte de soluție → nepedepsire. Favorizare și tăinuire: <b>membrul de familie</b> nu se pedepsește. Tăinuire = bunuri; favorizare = persoana. Spălare bani: <b>3–10 ani</b> (L. 129/2019); nu cere condamnare pentru predicat; auto-spălare doar lit. a-b (CCR 418/2018). Evaziune: 2–8; +5 ani (>100k €), +7 ani (>500k €); art. 10: prejudiciu+20%+dobânzi până la primul termen → limite reduse la jumătate.'
  },

  {
    ...
    sections:[
      { icon:'🚗', title:'Infracțiuni la regimul circulației pe drumuri publice (art. 334–341 NCP)',
        items:[
          '<b>Conducerea fără permis</b> (art. 335): alin. 1 — persoana care <b>nu a deținut niciodată permis</b>: <b>1–5 ani</b>; alin. 2 — permis <b>necorespunzător categoriei, suspendat, anulat sau retras</b>: <b>6 luni–3 ani sau amendă</b> (⚠️ nu aceeași sancțiune!).',
          '<b>Conducerea sub influența alcoolului</b> (art. 336): îmbibație alcoolică <b>de PESTE 0,80 g/l alcool pur în sânge</b> (exact 0,80 = contravenție!) sau sub influența substanțelor psihoactive. Infracțiune de pericol — consumată indiferent de accident.',
          '<b>Refuzul recoltării de probe biologice</b> (art. 337): refuzul de a se supune prelevării de mostre biologice; pedeapsă <b>1–5 ani</b>. Infracțiune <b>distinctă</b> față de conducerea sub alcool.',
          '<b>Vehiculul neînmatriculat</b> (art. 334 NCP): punerea în circulație sau conducerea unui vehicul <b>neînmatriculat</b> (1–3 ani) ori cu <b>număr fals</b> de înmatriculare (1–5 ani). ⚠️ Nu există infracțiunea „conducere periculoasă" — depășirea vitezei, trecerea pe roșu etc. sunt <b>contravenții</b>.',
      ...
      { icon:'🖥️', title:'Infracțiunile informatice (art. 360–366 NCP)',
        items:[
          '<b>Accesul ilegal la un sistem informatic</b> (art. 360 NCP) — trei trepte: acces fără drept (simplu): <b>3 luni–3 ani sau amendă</b>; în scopul obținerii de date informatice: <b>6 luni–5 ani</b>; cu <b>încălcarea măsurilor de securitate</b>: <b>2–7 ani</b>.',
          '<b>Interceptarea ilegală a unei transmisii de date informatice</b> (art. 361 NCP), inclusiv a emisiei electromagnetice purtătoare de date: <b>1–5 ani</b>.',
          '<b>Alterarea integrității datelor informatice</b> (art. 362 NCP): modificarea, ștergerea sau deteriorarea de date ori restricționarea accesului la ele, fără drept: <b>1–5 ani</b>. ⚠️ Diferit de frauda informatică (art. 249): art. 362 nu cere scop patrimonial.',
          '<b>Perturbarea funcționării sistemelor informatice</b> (art. 363 NCP): perturbarea gravă, fără drept, prin introducerea/transmiterea/modificarea de date (ex: atacuri DDoS): <b>2–7 ani</b>. <b>Transferul neautorizat de date</b> (art. 364): <b>1–5 ani</b>.',
          '<b>Operațiunile ilegale cu dispozitive sau programe informatice</b> (art. 365 NCP): producerea, importul, distribuirea sau punerea la dispoziție de programe/dispozitive/parole concepute pentru comiterea infracțiunilor informatice (malware, exploit kits): <b>6 luni–3 ani sau amendă</b>.',
          '⚠️ <b>Distincție sistematică</b>: art. 360 = acces; art. 361 = interceptare; art. 362 = alterare date; art. 363 = perturbare sistem; art. 364 = <b>transfer neautorizat de date</b>; art. 365 = instrumente de atac; <b>falsul informatic = art. 325</b> (la falsuri, nu aici!). Tentativa se pedepsește (art. 366). Origine: Convenția de la Budapesta (2001), preluate din L. 161/2003 în NCP.'
        ]
      },
      { icon:'🔍', title:'Recapitulare — delimitări esențiale infracțiuni speciale',
        items:[
          ...
          '<b>Furt / abuz de încredere / înșelăciune / tâlhărie</b>: furt = luare fără consimțământ. Abuz de încredere = primit cu consimțământ, nerestituit/însușit. Înșelăciune = consimțământul viciat prin eroare + prejudiciu. Tâlhărie = furt + violență (chiar ulterioară luării).',
          ...
          '<b>Tăinuire / favorizare</b>: tăinuire = <i>bunuri</i> provenite din faptă penală. Favorizare = <i>persoana</i> făptuitorului e ajutată să se sustragă. <b>Membrul de familie</b> nu se pedepsește <b>în ambele cazuri</b> (art. 269 alin. 3, art. 270 alin. 3).'
        ]
      }
    ],
    grila:'Conducere sub alcool: <b>peste 0,80 g/l</b> alcool pur în sânge (exact 0,80 = contravenție); consumată fără accident; dacă accident → concurs cu ucidere/vătămare din culpă. Permis: niciodată deținut → 1–5; suspendat/anulat/necorespunzător → 6 luni–3 ani. Art. 334 = vehicul neînmatriculat (nu „conducere periculoasă" — viteza/roșu = contravenții!). Omor = intenție față de deces; loviri cauzatoare de moarte = praeterintenție. Vătămare corporală: prag <b>90 zile</b>. Informatice: acces art. 360 (<b>3 luni–3 ani / 6 luni–5 / 2–7</b> cu securitate încălcată), interceptare 361 (<b>1–5</b>), alterare date 362 (<b>1–5</b>), perturbare 363 (<b>2–7</b>), transfer date 364 (1–5); falsul informatic = <b>art. 325</b>. Fraudă informatică (art. 249) ≠ alterare date (art. 362): la fraudă se cere scop patrimonial. Membrul de familie: nepedepsit și la favorizare, și la tăinuire.'
  },
...

  {
    ...
    sections:[
      { icon:'🏛️', title:'Competența instanțelor (art. 94–147 NCPC)',
        items:[
          '<b>Judecătoria</b> (art. 94 NCPC): cereri evaluabile în bani <b>până la 200.000 lei inclusiv</b>; plângeri contravenționale; evacuare; îngrădiri/grănițuire; iar <b>indiferent de valoare</b>: partajul judiciar, cererile de moștenire, cele privind uzucapiunea, fondul funciar (capcană: partajul NU depinde de valoare!).',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q36]</b> În situația transmisiunii, în condițiile legii, a calității procesuale <span style="color:var(--sub);font-size:0.9em">a) succesorul cu titlu particular nu este obligat să intervină în cauză, dacă are cunoștință de existența procesului · b) hotărârea pronunțată contra înstrăinătorului sau succesorului universal ori cu titlu universal al acestuia va produce de drept efecte și contra succesorului cu titlu particular și va fi întotdeauna opozabilă acestuia din urmă, fără excepție · c) dacă în cursul procesului dreptul litigios este transmis prin acte între vii cu titlu particular, judecata va continua între părțile inițiale</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 39 alin. (1) C.proc.civ., dacă în cursul procesului dreptul litigios este transmis prin acte între vii cu titlu part…</span>',
          '📌 <b>[Iul 2026 · G3 · Q38]</b> In situația transmisiunii, în condițiile legii, a calității procesuale <span style="color:var(--sub);font-size:0.9em">a) succesorul cu titlu particular nu este obligat să intervină în cauză, dacă are cunoștință de existența procesului · b) hotărârea pronunțată contra înstrăinătorului sau succesorului universal ori cu titlu universal al acestuia va produce de drept efecte și contra succesorului cu titlu particular și va fi întotdeauna opozabilă acestuia din urmă, fără excepție · c) dacă. în cursul procesului dreptul litigios este transmis prin acte între vii cu titlu particular, judecata va continua între părțile inițiale</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">Art. 39 alin. (1) C. proc. civ. prevede expres că dacă în cursul procesului dreptul litigios este transmis prin acte între vii cu…</span>',
          '📌 <b>[Iul 2026 · G1 · Q37]</b> În cazul coparticipării procesuale <span style="color:var(--sub);font-size:0.9em">a) dacă prin natura raportului juridic , efectele hotărârii se întind asupra tuturor reclamanților ori pârâților, termenele încuviințate numai unora dintre ei pentru îndeplinirea actelor de procedură profită și celorlalți · b) pârâții care nu s-au înfățișat, vor continua să fie citați, chiar dacă au termen în cunoștință · c) principiul independenței procesuale se aplică în toate cazurile</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 60 alin. (2) C.proc.civ., dacă prin natura raportului juridic sau în temeiul unei dispoziții a legii, efectele hotăr…</span>'
        ]
      },
      { icon:'⚖️', title:'Acțiunea civilă, excepții și participanți (art. 29–88 NCPC)',
        items:[
          ...
          '<b>Excepțiile peremptorii</b> (sting acțiunea): prescripția dreptului la acțiune, autoritatea de lucru judecat, lipsa calității procesuale, lipsa capacității procesuale de folosință, lipsa de interes.',
      ...
      { icon:'📂', title:'Hotărârea și căile de atac',
        items:[
          ...
          '<b>Contestația în anulare</b> (art. 503 NCPC): cale de <b>retractare</b> contra hotărârilor <b>definitive</b>; motive: (1) contestatorul <b>nu a fost legal citat</b> și nici prezent la termenul dezbaterilor; (2) la hotărârile instanțelor de recurs: dezlegarea dată e rezultatul unei <b>erori materiale</b>, instanța a <b>omis</b> să cerceteze un motiv de casare etc. Termen: <b>15 zile</b> de la comunicare, dar nu mai târziu de <b>1 an</b> de la definitivare. ⚠️ „Hotărâri potrivnice" e motiv de <b>revizuire</b>, nu de contestație!',
      ...
      { icon:'⏲️', title:'Termenele procedurale și nulitatea actelor de procedură (art. 174–186 NCPC)',
        items:[
          ...
          '<b>Incompatibilitatea judecătorului</b> (art. 41–42 NCPC): cazuri <b>absolute</b> (art. 41 — a pronunțat o hotărâre în cauză, a fost martor/expert/avocat în ea) — invocabile <b>oricând</b>; cazuri <b>relative</b> (art. 42 — rudenie, interes, dușmănie, antepronunțare) → <b>abținere</b> sau <b>recuzare</b>; recuzarea se cere <b>înainte de începerea dezbaterilor</b> (sau de îndată ce motivul e cunoscut) și se judecă de <b>un alt complet al aceleiași instanțe</b>, în camera de consiliu.',
          '<b>Introducerea forțată în cauză, din oficiu, a altor persoane</b> (art. 78–79 NCPC): în procedura <b>contencioasă</b>, numai în cazurile expres prevăzute de lege (+ necontencioasă: oricând); dacă părțile se opun în cazurile în care legea o permite, instanța poate <b>respinge cererea</b> fără a judeca fondul.',
          '<b>Cererile de valoare redusă</b> (art. 1026–1033 NCPC): procedură specială pentru creanțe ≤ <b>10.000 lei</b> (fără materii excluse: fiscal, familie, moșteniri, imobile...); pe bază de <b>formulare</b>, de regulă <b>fără dezbatere orală</b>; hotărârea = <b>executorie de drept</b>, atacabilă numai cu <b>apel în 30 de zile</b>.'
        ]
      },
      { icon:'⚡', title:'Ordonanța președințială (art. 997–1002 NCPC)',
        items:[
          ...
          '<b>Procedura</b> (art. 999–1000 NCPC): judecată de urgență, cu citarea părților (în cazuri deosebit de urgente — chiar fără citare); pronunțarea se poate amâna <b>cel mult 24 de ore</b>, motivarea se face în <b>cel mult 48 de ore</b>; ordonanța e <b>executorie de drept</b>, fără somație. Calea de atac: <b>apel în 5 zile</b> de la pronunțare (cu citare) sau de la comunicare (fără citare).',
      ...
      { icon:'🪑', title:'Judecata în lipsă și procedura contumaciei (art. 223–225 NCPC)',
        items:[
          ...
          '<b>Citarea</b>: condiție fundamentală a judecății — nulitate absolută dacă o parte nu a fost citată legal (motiv de contestație în anulare). Citarea prin publicitate = excepțională (adresă necunoscută). ⚠️ Reper esențial sub NCPC: <b>primul termen de judecată la care părțile sunt legal citate</b> (noțiunea „prima zi de înfățișare" era vechiul CPC) — de el se leagă invocarea necompetenței, modificarea cererii etc.'
        ]
      },
      ...
      { icon:'⚖️', title:'Principiile fundamentale ale procesului civil (art. 5–22 NCPC)',
        items:[
          '<b>Dreptul la un proces echitabil</b> (art. 6 NCPC): orice persoană are dreptul la judecarea cauzei în <b>termen optim și previzibil</b>, de un tribunal imparțial și independent. Baza: art. 6 CEDO. Instanța are obligația de a asigura un termen rezonabil.',
          '<b>Legalitatea</b> (art. 7 NCPC): judecătorii sunt obligați să respecte legea; nu pot refuza judecata pe motiv de lipsă sau obscuritate a normei (<i>non liquet</i> interzis). Dacă legea e neclară, interpretează și aplică.',
          '<b>Disponibilitatea</b> (art. 9 NCPC): reclamantul stabilește cadrul procesual (obiect, cauză, pretenții, cadrul procesual subiectiv); instanța nu poate depăși limitele cererii, nu poate schimba temeiul sau obiectul. Reclamantul poate renunța la judecată sau la drept, poate încheia tranzacție.',
          '<b>Contradictorialitatea</b> (art. 14 NCPC): nicio cerere, apărare sau probă nu se poate adopta fără a fi pusă <b>în discuția contradictorie</b> a tuturor părților; orice act de procedură trebuie comunicat. ⚠️ Excepție limitată: unele măsuri provizorii (asigurătorii) pot fi luate fără audierea pârâtului.',
          '<b>Rolul activ al judecătorului</b> (art. 22 NCPC): judecătorul poate <b>califica juridic raportul litigios</b> diferit de cum l-au calificat părțile (cu obligația de a pune aceasta în discuție); poate solicita lămuririle necesare; poate dispune probe din oficiu (dacă legea o permite); poate invoca din oficiu nulitățile absolute.',
          '<b>Buna-credință procesuală</b> (art. 12 NCPC): exercitarea drepturilor procesuale cu rea-credință sau neglijență → <b>amendă judiciară</b> (art. 187–188 NCPC) și daune față de cealaltă parte (art. 189 NCPC). Abuzul de drept procesual = sancție separată față de sancțiunile din dreptul material.',
          '<b>Alte principii</b>: <b>nemijlocirea</b> (art. 16 — instanța administrează probele direct); <b>continuitatea</b> completului (art. 19 — același complet de la debut la final, schimbare excepțională); <b>publicitatea</b> (art. 17 — ședințele sunt publice, cu excepțiile legale); <b>oralitatea</b> (art. 15 — dezbaterea orală a cauzei, deși documentele se depun în scris).'
        ]
      },
      { icon:'👥', title:'Participanții la procesul civil — instanța, coparticiparea, terții (art. 36–88 NCPC)',
        items:[
          '<b>Compunerea instanței</b>: în primă instanță — <b>1 judecător</b>; la Curțile de Apel în apel — <b>2 judecători</b> (completul de divergență: 3); la ÎCCJ în recurs — <b>3 judecători</b>. Incompletul de 3 judecători la Curte de Apel în materie de drept al muncii este o excepție.',
          '<b>Incompatibilitatea</b> (art. 41–44 NCPC): <b>absolută</b> (judecătorul a pronunțat o hotărâre în aceeași cauză sau a dat aviz consultativ — exclus de drept, fără recuzare); <b>relativă</b> (rudenie cu o parte, interes în cauză, alte motive — se declară prin recuzare sau abținere). ⚠️ Incompatibilitatea absolută poate fi invocată oricând, inclusiv în apel/recurs; cea relativă — numai la primul termen după ce s-a cunoscut cauza.',
          '<b>Coparticiparea procesuală</b> (art. 59–66 NCPC): mai mulți reclamanți sau pârâți în același proces. <b>Activă</b> (reclamanți multipli), <b>pasivă</b> (pârâți multipli) sau <b>mixtă</b>. ⚠️ <b>Litisconsorțiu necesar</b>: raporturi juridice indivizibile sau solidare → toți trebuie citați (instanța poate introduce din oficiu, art. 78 NCPC); <b>litisconsorțiu facultativ</b>: raporturi separate dar conexe — acțiunile se pot uni.',
          '<b>Intervenția voluntară</b> (art. 61–67 NCPC): <b>principală</b> — terțul pretinde pentru sine dreptul dedus judecății sau drept strâns legat; judecată ca o cerere separată, cu acordul părților sau la cererea terțului. <b>Accesorie</b> — terțul ajută una din părți; judecată odată cu cererea principală, soarta intervenitorului urmează soarta celui sprijinit.',
          '<b>Intervenția forțată</b>: (1) <b>chemarea în judecată a altor persoane</b> (art. 68–71): una din părți cere introducerea unui terț care ar putea pretinde aceleași drepturi; (2) <b>chemarea în garanție</b> (art. 72–74): o parte cheamă o terță persoană față de care are un drept de regres sau garanție; (3) <b>arătarea titularului dreptului</b> (art. 75–77): pârâtul arată că deține bunul pentru un terț și cere introducerea acestuia.',
          '<b>Reprezentarea</b> (art. 80–89 NCPC): în fața judecătoriei și tribunalului, în materie civilă — reprezentarea prin avocat e facultativă; în fața Curților de Apel și ÎCCJ — reprezentarea prin <b>avocat sau consilier juridic</b> e <b>obligatorie</b> în faza recursului. ⚠️ La persoanele juridice de drept public — consilierul juridic angajat; la cele de drept privat — avocat sau consilier juridic (dacă au).'
        ]
      },
      { icon:'💳', title:'Ordonanța de plată (art. 1013–1024 NCPC)',
        items:[
          '<b>Domeniu</b>: procedură specială pentru recuperarea <b>creanțelor certe, lichide și exigibile</b> constând în sume de bani, rezultate din contracte civile sau comerciale, inclusiv din contracte de împrumut bancar.',
          '<b>Procedura</b>: (1) creditorul somează debitorul să plătească în <b>15 zile</b>; (2) dacă nu plătește, depune cerere la instanță + documentele care probează creanța; (3) instanța citează debitorul → debitorul poate plăti sau formula obiecțiuni; (4) dacă debitorul nu contestă sau contestația e respinsă → instanța emite ordonanța de plată.',
          '<b>Ordonanța de plată</b>: e o <b>hotărâre judecătorească</b> cu caracter executoriu — <b>executorie de drept</b> de la data comunicării (art. 1021 NCPC). Nu necesită învestire cu formulă executorie. ⚠️ Dacă debitorul contestă creanța → instanța poate respinge cererea de ordonanță de plată și trimite creditorul la procedura de drept comun.',
          '<b>Calea de atac</b> (art. 1023 NCPC): <b>cererea în anulare</b> (NU apel, NU recurs!) în termen de <b>10 zile</b> de la comunicarea ordonanței, la aceeași instanță. Dacă e admisă cererea în anulare → ordonanța se desființează, iar creditorul poate urma procedura de drept comun. Hotărârea pronunțată în cererea în anulare e <b>definitivă</b>.',
          '⚠️ <b>Capcane</b>: (a) ordonanța de plată ≠ ordonanța președințială (proceduri complet diferite: ordonanța de plată = creanțe; ordonanța președințială = măsuri provizorii urgente); (b) ordonanța de plată ≠ somația de plată (aceea era un mecanism anterior, abrogat prin NCPC); (c) creanța trebuie să fie <b>certă, lichidă și exigibilă</b> — dacă debitorul contestă serios existența creanței → instanța respinge cererea (nu se judecă fondul în această procedură).'
        ]
      },
      { icon:'🔐', title:'Cauțiunea judiciară (art. 1057–1066 NCPC)',
        items:[
          '<b>Definiție</b>: sumă de bani sau altă valoare constituită la dispoziția instanței, drept <b>garanție</b> pentru acoperirea eventualelor daune cauzate celeilalte părți printr-o măsură judiciară temporară sau pentru asigurarea cheltuielilor de judecată.',
          '<b>Când se constituie</b>: (1) la cerere sau din oficiu, pentru <b>suspendarea executării</b> hotărârii de primă instanță (pe durata apelului); (2) la acordarea <b>ordonanței președințiale</b>, pentru protejarea celui față de care e dispusă măsura; (3) la <b>sechestrul asigurător și poprirea asigurătorie</b> (art. 953–954 NCPC) — creditorul depune cauțiune dacă nu are titlu executoriu; (4) în orice alt caz prevăzut de lege.',
          '<b>Forma</b> (art. 1057 NCPC): suma de bani se depune la <b>CEC Bank sau o unitate bancară</b>, la dispoziția instanței. Alternativ: scrisoare de garanție bancară irevocabilă. Cauțiunea se consemnează și se eliberează printr-o încheiere judecătorească.',
          '<b>Eliberarea cauțiunii</b> (art. 1064–1066 NCPC): (1) dacă măsura pentru care s-a constituit n-a produs nicio pagubă adversarului → se restituie celui care a depus-o; (2) dacă măsura a cauzat daune → adversarul are drept de preferință asupra cauțiunii pentru acoperirea daunelor. ⚠️ Cauțiunea depusă pentru suspendarea executării: dacă hotărârea e <b>menținută în apel</b> → se restituie depunătorului; dacă e <b>desființată</b> → se eliberează creditorului executant pentru daune.',
          '⚠️ <b>Distincție</b>: cauțiunea judiciară (procedura civilă) ≠ cauțiunea penală (controlul judiciar pe cauțiune, art. 216 CPP — aceea e o garanție personală pentru a evita arestul preventiv, cu o valoare fixă stabilită de instanță).'
        ]
      }
    ],
    grila:'Competența teritorială de drept comun = domiciliul <b>pârâtului</b>. Apel: <b>30 de zile</b> de la <i>comunicare</i>. Recursul = numai în drept. Autoritatea de lucru judecat: tripla identitate obiect + cauză + <b>părți</b>. Excepție peremptoriu → stinge acțiunea. Litispendență = 2 instanțe, același litigiu → dosarul mai nou la instanța mai veche. Cerere reconvențională: depusă cu întâmpinarea. Necompetență: <b>generală → oricând</b>; <b>materială/teritorial-exclusivă → primul termen cu părțile legal citate</b> (capcană NCPC!); relativă → numai pârâtul prin întâmpinare. Partaj/moștenire/uzucapiune → judecătorie <b>indiferent de valoare</b>. Ordonanță președințială: urgentă, provizorie, fără prejudecarea fondului; apel în <b>5 zile</b>. Judecata în lipsă: pârâtul fără întâmpinare = decăzut din probe. Perimarea = <b>6 luni</b> de nediligență → stinge cererea nu dreptul. Cheltuieli: cel care pierde plătește; reducere onorar avocat posibilă.'
  },
...

  {
    ...
    sections:[
      { icon:'⚖️', title:'Principii fundamentale (art. 2–12 CPP)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1 · Q86]</b> În ceea ce privește renunțarea la urmărirea penală <span style="color:var(--sub);font-size:0.9em">a) în cazul în care, în urma verificării sub aspectul legalității și temeiniciei, ordonanța de renunțare este infirmată de către procurorul ierarhic superior, o nouă renunțare nu mai poate fi dispusă, indiferent de motivul invocat · b) renunțarea poate fi dispusă în cazul unei infracțiuni de ucidere din culpă · c) prin ordonanța de renunțare procurorul poate sesiza judecătorul de cameră preliminară cu propunerea de luare a măsurii de siguranță a confiscării speciale</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">conform art. 318 alin. (8) raportat la art. 315 alin. (2) lit. c) C.proc.pen., prin ordonanța de renunțare procurorul poate sesiza…</span>',
          '📌 <b>[Iul 2026 · G2 · Q92]</b> În cazul în care persoana interesatä formulează in termen de 20 de zile de la comunicar… <span style="color:var(--sub);font-size:0.9em">a) judecătorul de cameră preliminară va respinge plângerea ca inadmisibilă · b) judecătorul de cameră preliminară trimite pe cale administrativă plângerea organului judiciar competent · c) judecătorul de cameră preliminară va proceda la</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">plângerea la judecătorul de cameră preliminară (art. 340 alin. (1) CPP) presupune parcurgerea prealabilă a procedurii de la art. 3…</span>',
          '📌 <b>[Iul 2026 · G3 · Q95]</b> In cazul în care persoana interesată formulează în termen de 20 de zile de la comunicar… <span style="color:var(--sub);font-size:0.9em">a) judecătorul de cameră preliminară va respinge plângerea ca inadmisibilă · b) judecătorul de cameră preliminară trimite pe cale administrativă plângerea organului judiciar competent · c) judecătorul de cameră preliminară va proceda la soluționarea plângerii pe fond. E2323</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">plângerea la judecătorul de cameră preliminară presupune parcurgerea prealabilă a procedurii la procurorul ierarhic superior (art.…</span>'
        ]
      },
      ...
      { icon:'🔄', title:'Căile extraordinare de atac penale (art. 426–470 CPP)',
        items:[
          '<b>Contestația în anulare</b> (art. 426 CPP): împotriva hotărârilor penale definitive. Motive principale: judecata în apel <b>fără citarea legală</b> a unei părți; condamnare deși existau probe cu privire la o <b>cauză de încetare</b> a procesului; instanța <b>necompetentă</b> sau <b>nelegal compusă</b>/judecător incompatibil; lipsa participării obligatorii a procurorului/inculpatului; lipsa expertizei psihiatrice obligatorii; <b>două hotărâri definitive pentru aceeași faptă</b>. Termen: <b>30 de zile</b> de la comunicare (pentru unele motive — oricând).',
      ...
      { icon:'🔄', title:'Reabilitarea (art. 165–171 NCP)',
        items:[
          '<b>Efectul reabilitării</b> (art. 169 NCP): face să înceteze <b>decăderile, interdicțiile și incapacitățile</b> ce decurg din condamnare. Important: după reabilitare, condamnarea <b>nu mai poate constitui prim termen al recidivei</b> (art. 41: recidiva există doar „până la reabilitare"). ⚠️ Reabilitarea nu obligă la reintegrarea în funcția pierdută și nu restituie amenda plătită.',
      ...
      { icon:'🔎', title:'Participanții în procesul penal — judecătorul de drepturi, incompatibilitate, avocat (art. 30–92 CPP)',
        items:[
          '<b>Judecătorul de drepturi și libertăți</b> (art. 53 CPP): judecător de la instanța competentă, care soluționează în cursul <b>urmăririi penale</b> cererile, propunerile și contestațiile privind: măsuri preventive (arest preventiv, arest la domiciliu, control judiciar pe cauțiune), percheziție domiciliară, interceptări, supraveghere tehnică. ⚠️ Judecătorul de drepturi și libertăți care a dispus o măsură de supraveghere sau o măsură preventivă NU poate judeca fondul cauzei (art. 64 alin. 4 CPP — incompatibilitate).',
          '<b>Judecătorul de cameră preliminară</b> (art. 54 CPP): verifică <b>după trimiterea în judecată</b> legalitatea sesizării instanței, a administrării probelor și a efectuării actelor de urmărire penală. ⚠️ Distinct de judecătorul de drepturi și libertăți — acesta verifică legalitatea în cursul UP; judecătorul de cameră preliminară verifică legalitatea <b>după</b> trimitere, înainte de judecată.',
          '<b>Incompatibilitatea</b> (art. 64–67 CPP): judecătorul nu poate participa la soluționarea cauzei dacă: a mai soluționat cauza în fond (recurs, rejudecare); a fost judecător de drepturi și libertăți sau de cameră preliminară în cauza respectivă (nu judecă fondul); există relații de rudenie/interes cu o parte; a efectuat acte de urmărire penală. ⚠️ Judecătorul care a participat la soluționarea cauzei în primă instanță NU poate judeca <b>apelul</b> în aceeași cauză.',
          '<b>Organele de urmărire penală</b>: procurorul (conduce și supraveghează urmărirea) + organele de cercetare (polițiștii de investigații criminale, organe speciale). ⚠️ <b>Strămutarea</b> (art. 71–75 CPP): judecarea cauzei de o altă instanță egală în grad, pentru buna desfășurare a procesului sau imparțialitate; hotărăște <b>ÎCCJ</b>; poate fi cerută de procuror, inculpat sau celelalte părți.',
          '<b>Avocatul</b> (art. 88–92 CPP): asistența juridică e <b>obligatorie</b> în cursul urmăririi penale și al judecății când: inculpatul e minor sau reținut/arestat; când e bolnav psihic sau în altă stare care îl împiedică să se apere; când pedeapsa prevăzută e detențiunea pe viață sau închisoarea mai mare de 5 ani; în procedura de cameră preliminară. ⚠️ Dacă avocatul ales nu se prezintă sau nu poate fi contactat, organele judiciare desemnează un avocat din oficiu — judecata NU se amână sine die din lipsă de apărător ales.'
        ]
      },
      { icon:'🚪', title:'Camera preliminară (art. 342–348 CPP)',
        items:[
          '<b>Scopul</b> (art. 342 CPP): verificarea, după sesizarea instanței prin rechizitoriu, a <b>legalității trimiterii în judecată</b> și a <b>legalității administrării probelor</b> și a efectuării actelor de urmărire penală.',
          '<b>Durata</b>: judecătorul de cameră preliminară se pronunță în cel mult <b>60 de zile</b> de la înregistrarea dosarului (art. 343 CPP). Procedura e <b>în cameră de consiliu</b> (nepublică), cu citarea inculpatului și a celorlalte părți.',
          '<b>Ce poate constata și dispune</b> (art. 345–346 CPP): (a) dacă rechizitoriul e <b>regulat întocmit</b> → începe judecata; (b) dacă există <b>neregularități ale actului de sesizare</b> → restituie dosarul parchetului pentru remediere (în 5 zile); (c) dacă probele au fost <b>nelegal administrate</b> → exclude acele probe (devin inutilizabile); (d) dacă <b>excluderea probelor lăsă fără suport acuzația</b> → poate dispune <b>clasarea cauzei</b>.',
          '<b>Căile de atac</b> (art. 347 CPP): împotriva încheierilor judecătorului de cameră preliminară se poate formula <b>contestație</b> (la instanța ierarhic superioară), în termen de <b>3 zile</b> de la comunicare. ⚠️ Nu există apel sau recurs în camera preliminară — numai contestație.',
          '⚠️ <b>Capcane</b>: (a) camera preliminară NU judecă vinovăția — numai legalitatea; (b) probele excluse în camera preliminară NU pot fi folosite în judecată; (c) judecătorul de cameră preliminară NU este același cu judecătorul de drepturi și libertăți și NU poate judeca fondul în aceeași cauză; (d) rechizitoriul ≠ trimiterea în judecată — rechizitoriul e actul prin care procurorul sesizează instanța; camera preliminară verifică dacă sesizarea e valabilă.'
        ]
      },
      { icon:'🤝', title:'Proceduri speciale PPEN — acordul de vinovăție, procedura cu minori, reabilitarea (art. 478–537 CPP)',
        items:[
          '<b>Acordul de recunoaștere a vinovăției</b> (art. 478–488 CPP): inculpatul recunoaște fapta și negociază cu <b>procurorul</b> tipul și cuantumul pedepsei; se poate încheia până la citirea actului de sesizare. Judecătorul verifică: consimțământul liber și voluntar, existența probelor, legalitatea. ⚠️ <b>Judecătorul NU poate modifica acordul</b> — îl <b>admite în totalitate</b> (prin sentință) sau îl <b>respinge</b> (cauza merge la judecată obișnuită). Pedeapsa rezultată din acord poate fi oricare, inclusiv suspendată — judecătorul poate dispune altfel numai dacă acordul nu respectă legea.',
          '<b>Procedura simplificată (recunoașterea învinuirii)</b> (art. 374–375 CPP): inculpatul recunoaște în ședință de judecată fapta în totalitate → instanța poate condamna cu reducerea cu <b>1/3 din limitele de pedeapsă</b> (la închisoare) sau cu reducerea cu <b>1/4 din amenda</b>. ⚠️ Diferit de acordul de recunoaștere: procedura simplificată e în faza judecății (nu în UP), fără negociere cu procurorul, și instanța e liberă să stabilească pedeapsa în limitele reduse.',
          '<b>Procedura în cauzele cu infractori minori</b> (art. 504–520 CPP): ședința de judecată e <b>nepublică</b>; psihologul/pedagogul și părinții/tutorele/reprezentantul legal participă obligatoriu. ⚠️ Instanța aplică numai <b>măsuri educative</b> (nu pedepse!) — aceste instituții sunt de drept penal material (NCP art. 114–131), dar procedura specială creează cadrul procesual specific.',
          '<b>Procedura reabilitării judecătorești</b> (art. 527–537 CPP): cerere la <b>instanța de executare</b> (cea care a judecat în primă instanță), după împlinirea termenelor din NCP (4/5/7 ani de la executarea pedepsei). Condiții verificate: termenul, conduita ulterioară, achitarea despăgubirilor civile și a cheltuielilor judiciare. Dacă sunt îndeplinite → instanța <b>admite reabilitarea</b>; dacă nu → respinge, cu posibilitatea reînnoirii cererii după <b>1 an</b>. ⚠️ Reabilitarea nu se acordă automat la împlinirea termenului — necesită hotărâre judecătorească (spre deosebire de reabilitarea de drept care e automată).'
        ]
      },
      { icon:'🏁', title:'Executarea hotărârilor penale (art. 549–599 CPP)',
        items:[
          '<b>Titlul executoriu</b>: hotărârea penală <b>definitivă</b> (rămasă definitivă prin neatacare sau prin pronunțarea instanței de apel). Executarea începe de drept de la data rămânerii definitive.',
          '<b>Instanța de executare</b> (art. 553 CPP): instanța care a judecat cauza în <b>primă instanță</b>. Ea coordonează executarea și soluționează incidentele survenite în cursul executării.',
          '<b>Executarea pedepsei principale</b>: pedeapsa închisorii/DPV — comunicare la <b>ANP</b> (Administrația Națională a Penitenciarelor) pentru punerea în executare; amenda — comunicare la <b>organul fiscal</b> competent. Dacă condamnatul nu se prezintă voluntar → emitere <b>mandat de executare a pedepsei</b> (arest).',
          '<b>Contestația la executare</b> (art. 598 CPP): împotriva actelor de executare și a oricăror <b>incidente survenite în cursul executării</b>. Motive: nelegalitatea actului de executare, lămurirea înțelesului hotărârii, stingerea sau înlocuirea pedepsei, intervenirea grațierii. ⚠️ Contestația la executare penală ≠ contestația la executare civilă — proceduri complet diferite, instanțe diferite, motive diferite.',
          '⚠️ <b>Liberarea condiționată</b> (art. 587 CPP): la cererea condamnatului sau la sesizarea comisiei din penitenciar, judecătoria în a cărei circumscripție se află penitenciarul verifică îndeplinirea condițiilor (fracția executată, conduita, repararea daunelor) și dispune sau nu liberarea. Contestație: la Tribunalul în circumscripția căruia e judecătoria, în <b>3 zile</b> de la comunicare. ⚠️ Dacă cel liberat condiționat comite o infracțiune intenționată → <b>revocare obligatorie</b>; din culpă sau contravenție → revocare facultativă.'
        ]
      }
    ],
    grila:'Reținere = max. <b>24h</b>, fără mandat. Arest preventiv în urmărire: max. <b>180 de zile</b> total (câte 30). Apel penal: <b>10 zile</b> de la comunicarea minutei (nu 30!). Sarcina probei = <b>organele judiciare</b>; in dubio pro reo = dubiul → achitare. Suspect ≠ inculpat: acțiunea penală pusă în mișcare → inculpat. Acordul de recunoaștere: instanța omologhează sau respinge în bloc. Procedura simplificată (recunoaștere) → 1/3 reducere. Reabilitare de drept (≤2 ani sau amendă/suspendare): automată după <b>3 ani</b>. Reabilitare judecătorească: termene <b>fixe 4/5/7 ani</b> (nu „+durata pedepsei" — capcană, era vechiul cod!); DPV comutată → 7 ani. După reabilitare: condamnarea nu mai e prim termen al recidivei. Control judiciar: total max 1 an/2 ani în urmărire. Arest în judecată: max ½ din maximul special, plafon 5 ani. Contestație în anulare: procedură (necitare/constituire nelegală). Revizuire: fapte/probe noi, oricând. Recurs în casație: în drept, <b>30 de zile</b>. Excluderea probelor (art. 102): probe nelegale = inutilizabile.'
  },
...
var FISE_TIPS={
  ...
  w03:[
    ...
    '⚠️ Imposibilitatea <b>inițială</b> de executare NU mai atrage nulitatea sub NCC — contractul e <b>valabil</b> (art. 1227), debitorul răspunde pentru neexecutare. Imposibilitatea <b>ulterioară fortuită</b> → stingerea obligației. Grilă: „bunul nu putea fi procurat la încheiere → contract nul" = FALS.',
    ...
    'Actul solemn defectuos formal poate valora ca <b>promisiune de contract</b> dacă exprimă acordul de voință al părților (art. 1243 NCC).',
    '⚠️ <b>Lipsa cauzei → anulabilitate (NR)</b>, nu NCA (art. 1238 alin. 1 — capcană: sub vechiul cod era NCA). Preț fictiv sau derizoriu → vânzare <b>anulabilă</b> (art. 1665).',
    '⚠️ <b>Excepția de nulitate relativă</b>: partea căreia i se cere executarea o poate opune <b>oricând</b>, chiar după prescripția acțiunii (art. 1249 alin. 2). Grilă: „au trecut 3 ani → nu mai poate invoca NR nici în apărare" = FALS.'
  ],
  w04:[
    ...
    'Termen general: <b>3 ani</b>. Drepturi reale (art. 2518): <b>10 ani</b>. Leziune: <b>1 an de la data actului</b>. Acțiuni posesorii: <b>1 an</b>. Vicii ascunse: 3 ani, dar prescripția începe cel târziu la <b>1 an de la predare</b> (3 ani la construcții — art. 2531). ⚠️ Nu există „6 luni pentru vicii" — capcană din vechiul regim.',
    ...
    '⚠️ <b>Capcană — restituirea la cauza imorală</b>: sub NCC prestația executată în temeiul unei cauze ilicite sau imorale <b>rămâne ÎNTOTDEAUNA supusă restituirii</b> (art. 1638) — regula <i>nemo auditur</i> NU se mai aplică restituirilor! Dacă grila întreabă dacă restituirea e posibilă → DA.',
  ...
  w05:[
    '⚠️ <b>Capcana partajului</b>: sub NCC partajul are efect <b>CONSTITUTIV</b> (art. 680) — fiecare coproprietar devine proprietar exclusiv <b>de la data partajului</b> (la imobile, de la înscrierea în CF), NU retroactiv. „Efectul declarativ" era vechiul cod — grilă frecventă!',
    '⚠️ <b>Capcana CF</b>: efectul constitutiv al înscrierii (art. 885 NCC) e <b>amânat</b> (art. 56 L. 71/2011) până la finalizarea cadastrului pe UAT-uri — înscrierea rămâne azi de <b>opozabilitate</b>; proprietatea se transmite prin acordul de voință.',
    '⚠️ <b>Retractul litigios NU mai există</b> în NCC (era vechiul cod). A rămas doar interdicția dobândirii drepturilor litigioase de către judecători, procurori, avocați, notari, executori (art. 1653) → <b>nulitate absolută</b>.',
  ...
  w06:[
    ...
    'Uzufructul este <b>temporar</b>: se stinge cel târziu la moartea uzufructuarului și <b>nu se transmite prin moștenire</b>. Poate fi <b>constituit</b> prin testament (legat) și poate fi <b>cedat</b> între vii (art. 714) — dar și după cesiune se stinge tot la moartea uzufructuarului <b>inițial</b>.',
    ...
    '⚠️ <b>Capcana servituților</b>: regula NCC (art. 763) — prin uzucapiune <b>tabulară</b> se dobândește <b>orice</b> servitute; prin uzucapiune <b>extratabulară</b> — numai servituțile <b>pozitive</b>. Criteriul vechi „continue și aparente" și „destinația proprietarului" NU mai există — dacă grila le folosește ca regulă actuală → greșit.',
  ...
  w07:[
    ...
    '⚠️ Viciile posesiei — nuanța care pică la grile: <b>discontinuitatea e ABSOLUTĂ</b> (o invocă orice persoană interesată); doar <b>violența și clandestinitatea sunt relative</b> (numai cel față de care s-au exercitat). Toate sunt <b>temporare</b> — posesia redevine utilă la încetarea viciului.',
  ...
  w09:[
    ...
    'Răspunderea pentru <b>minor/interzis</b> (art. 1372): revine celui <b>obligat la supraveghere</b> (lege/contract/hotărâre); ⚠️ NCC <b>nu mai cere</b> ca minorul să locuiască cu părinții (capcană — vechiul cod). Exonerarea <b>părinților</b> e aproape imposibilă: trebuie dovedit că fapta are <b>altă cauză decât modul de exercitare a autorității părintești</b> — nu simpla „supraveghere corectă".',
    '⚠️ <b>Capcana bunului furat</b>: <b>hoțul preia paza juridică</b> (control independent — art. 1377) → hoțul răspunde pentru prejudiciile cauzate de lucru, nu proprietarul deposedat. Grilă: „proprietarul mașinii furate răspunde pentru accidentul hoțului" = FALS.',
    'La răspunderea obiectivă (art. 1376 lucruri, art. 1375 animale, art. 1378 ruina edificiului): <b>cazul fortuit nu exonerează</b> — numai <b>forța majoră</b>. ⚠️ La ruina edificiului mai e o condiție frecvent testată: ruina să provină din <b>lipsa de întreținere sau un viciu de construcție</b> — altfel proprietarul nu răspunde pe art. 1378.',
  ...
  w10:[
    'Principiul integrității plății: creditorul <b>nu poate fi forțat să accepte plăți parțiale</b>, nici dacă datoria e divizibilă și nici dacă restul e cert. Excepție: convenție sau dispoziție legală expresă.',
    '⚠️ <b>Capcana locului plății</b> (art. 1494): obligațiile <b>bănești</b> → domiciliul <b>CREDITORULUI</b> (portabile — NCC a inversat regula veche!); celelalte obligații → domiciliul debitorului (cherabile). Grilă: „banii se plătesc la domiciliul debitorului" = FALS sub NCC.',
    '⚠️ <b>Pactul comisoriu</b> (art. 1553): valabil doar cu indicarea <b>expresă</b> a obligațiilor a căror neexecutare atrage rezoluțiunea; „gradele I–IV" = doctrina vechiului cod. Punerea în întârziere rămâne necesară dacă nu s-a stipulat că rezoluțiunea rezultă din simplul fapt al neexecutării.',
  ...
  w11:[
    ...
    'Acțiunea în simulație = acțiune în <b>constatare</b> → <b>imprescriptibilă</b> atât față de terți, cât și <b>între părți</b> (se prescriu doar acțiunile subsecvente pe actul secret). Grilă: „între părți se prescrie în 3 ani" = FALS.',
    '⚠️ <b>Capcana cesiunii de contract</b> (art. 1318): cedentul este <b>LIBERAT</b> din momentul în care substituirea produce efecte față de cedat — rămâne ținut doar dacă cedatul a <b>declarat că nu-l liberează</b>. Grilă: „cedentul rămâne obligat dacă nu s-a stipulat exonerarea" = FALS (regula e inversă).',
    '⚠️ <b>Delegația NU mai e reglementată de NCC</b> — funcțiile ei sunt preluate de novația prin schimbare de debitor (art. 1609) și preluarea datoriei (art. 1599–1608). Art. 1603–1608 = preluarea datoriei, nu „delegația".',
  ...
  w12:[
    ...
    '⚠️ <b>Capcana riscului</b> (art. 1274 NCC): cât timp bunul <b>nu e predat</b>, riscul rămâne la <b>VÂNZĂTOR</b> (debitorul predării), <b>chiar dacă proprietatea s-a transferat</b> cumpărătorului — <i>res perit debitori</i>, NCC a răsturnat vechiul <i>res perit domino</i>! Excepție: cumpărătorul <b>pus în întârziere</b> cu preluarea preia riscul. Grilă: „bunul a pierit fortuit înainte de predare → cumpărătorul plătește prețul" = FALS (dacă nu era în întârziere).',
    '⚠️ <b>Vânzarea bunului altuia</b> (art. 1683): contractul e <b>VALABIL</b> — vânzătorul e obligat să procure bunul; neexecutare → rezoluțiune + daune. „Anulabilă dacă cumpărătorul nu știa" = regula <b>vechiului cod</b>, răspuns greșit azi!',
    '⚠️ <b>Revocarea donației</b>: doar <b>două</b> cauze legale — neexecutarea sarcinii și ingratitudinea (art. 1020). „Survenirea de copil" NU mai e cauză legală (vechiul cod). Donația între soți: revocabilă <b>numai în timpul căsătoriei</b>. Dar manual: plafon <b>25.000 lei</b>.',
  ...
  w14:[
    ...
    '⚠️ <b>Fidejusiunea e SOLEMNĂ</b> (art. 2282): înscris autentic sau sub semnătură privată, <b>ad validitatem</b> (NCA) — „consensuală" = greșit. Iar <b>prelungirea termenului</b> acordată debitorului NU îl liberează pe fidejusor (art. 2311); liberarea reală: creditorul face imposibilă subrogația (art. 2315).',
    '⚠️ <b>Împrumutul de BANI se prezumă ONEROS</b> (art. 2159 alin. 2) — doar împrumutul altor bunuri se prezumă gratuit. Plafonul dobânzii convenționale: dobânda legală <b>+50%/an</b> (nu „2×"); depășire → clauză nulă + creditorul <b>decade și din dobânda legală</b> (art. 5 OG 13/2011).',
    ...
    'Tranzacția: efecte de regulă <b>declarative</b> (⚠️ nu o compara cu partajul — acela e constitutiv sub NCC). Are putere de lucru judecat <i>inter partes</i>; poate fi desființată doar pentru cauzele de nulitate specifice (drept inexistent, acte false etc.), nu reformată pe fond.'
  ],
  w15:[
    ...
    'Cotele <b>soțului supraviețuitor</b> (art. 972) — de memorat exact: <b>cls I = 1/4; cls II întreagă (ambele categorii) = 1/3; doar o categorie din cls II = 1/2; cls III sau cls IV = 3/4; singur = tot</b>. ⚠️ Nu există „3/8" — capcană frecventă!',
    '⚠️ <b>Capcana răspunderii moștenitorilor</b>: sub NCC toți răspund <b>INTRA VIRES</b> — numai cu bunurile succesorale, proporțional cu cota (art. 1114 alin. 2). „Beneficiul de inventar" NU mai există ca opțiune. Singura răspundere ultra vires: <b>sancțiunea acceptării forțate</b> (art. 1119 — sustragerea de bunuri).',
  ...
  w16:[
    ...
    '⚠️ <b>Capcana rezervei</b>: regula unică NCC (art. 1088) — rezerva fiecărui rezervatar = <b>1/2 din cota sa LEGALĂ</b>, nu fracțiuni fixe din moștenire! „Descendenți 1/2, ascendenți 1/2, soț 1/4 din moștenire" = sistemul vechiului cod, răspuns greșit. Ex: soț cu descendenți → rezervă 1/2 × 1/4 = <b>1/8</b>.',
    '<b>Reducțiunea</b> (art. 1096): mai întâi <b>legatele — toate deodată și proporțional</b>; abia apoi <b>donațiile — în ordinea inversă a datei</b> (cea mai nouă prima). ⚠️ „Legatele în ordine inversă creării" = greșit — doar donațiile se reduc cronologic invers.',
    '⚠️ <b>Capcana liberalităților minorului</b> (art. 988): cel fără capacitate deplină <b>NU poate face nicio liberalitate</b> (nici testament!). „Minorul de 16 ani dispune de 1/2" = vechiul cod. Iar nici după majorat nu poate gratifica <b>fostul reprezentant legal</b> înainte de descărcarea de gestiune.',
  ...
  w18:[
    ...
    '<b>Persoana juridică</b> poate fi subiect activ al infracțiunii (art. 135 NCP), cu excepția statului, autorităților publice și a celor care exercită prerogative de putere publică. Grilele testează uneori dacă PJ poate fi autor al anumitor infracțiuni.',
    '⚠️ <b>Error in persona vs. aberratio ictus</b>: la ambele, soluția majoritară română = <b>o singură infracțiune intenționată consumată</b> față de victima efectivă (identitatea victimei nu e element de tipicitate). Teza concursului la aberratio (tentativă + culpă) e opinie minoritară — atenție la formularea grilei.',
    '⚠️ <b>Lex tertia interzisă</b> (CCR 265/2014): la aplicarea legii penale mai favorabile nu se pot combina dispozițiile mai blânde din ambele legi — se alege o singură lege, în ansamblu.'
  ],
  ...
  w19:[
    ...
    '<b>Participația improprie</b> (art. 52): executantul acționează din culpă sau fără vinovăție (constrâns, în eroare, minor sub 14 ani) → cel care l-a determinat/ajutat cu intenție rămâne <b>instigator/complice</b>, dar se pedepsește cu pedeapsa prevăzută pentru fapta <b>intenționată</b>. („Autor mediat" nu e noțiune NCP!)',
    '⚠️ <b>Infracțiunea continuată</b>: condiția „același subiect pasiv" a fost declarată <b>neconstituțională</b> (CCR 368/2017) — poate exista și cu victime diferite. Sporul: maximul special <b>+cel mult 3 ani</b> (nu „1–3 ani"). Prescripția curge de la <b>epuizare</b>.',
  ...
  w20:[
    ...
    '<b>Starea de necesitate</b>: condiția e ca urmările să nu fie <b>vădit mai grave</b> decât cele evitate — un rău egal nu exclude justificarea. ⚠️ Depășirea din <b>tulburare sau temere</b> = <b>exces NEIMPUTABIL</b> (art. 26 — nu răspunde!); depășirea conștientă = doar circumstanță atenuantă. Grilă care zice „excesul din temere = atenuare" → FALS, e neimputabilitate.',
    'Minoritate: <b>sub 14 ani</b> → nicio răspundere penală. <b>14–16 ani</b> → răspundere numai cu <b>discernământ dovedit</b>. <b>16–18 ani</b> → răspunde penal. ⚠️ <b>Capcană</b>: minorii primesc exclusiv <b>măsuri educative</b> (neprivative sau privative) — „pedepse reduse la jumătate" = vechiul cod, răspuns greșit!',
  ...
  w22:[
    ...
    '⚠️ <b>Capcana uzului de fals</b>: la înscrisurile <b>OFICIALE</b>, chiar autorul falsului care îl folosește răspunde în <b>CONCURS</b> (fals material + uz de fals). Absorbția operează numai la falsul în înscrisuri <b>sub semnătură privată</b> (art. 322 — folosirea e element constitutiv). Grilă: „falsificatorul actului oficial care l-a depus la primărie comite o singură infracțiune" = FALS.',
  ...
  w23:[
    ...
    '⚠️ <b>Capcana auto-spălării</b> (CCR 418/2018): autorul infracțiunii predicat poate răspunde pentru spălare doar în variantele <b>a) și b)</b> (schimbare/transfer, ascundere/disimulare) — NU pentru lit. c) (dobândire/deținere/folosire). Grilă: „hoțul care doar folosește banii furați comite și spălare" = FALS.',
    '⚠️ <b>Evaziunea — art. 10 L. 241/2005</b> (forma actuală): plata prejudiciului <b>+20% + dobânzi și penalități</b> până la primul termen → limitele pedepsei <b>reduse la jumătate</b>. Acoperirea simplă/parțială nu mai produce acest efect.'
  ],

  w24:[
    'Conducere sub influența alcoolului (art. 336): infracțiune doar <b>PESTE 0,80 g/l</b> alcool pur în sânge — exact 0,80 sau sub = contravenție. Infracțiunea e consumată indiferent dacă s-a produs un accident.',
    '⚠️ <b>Nu există infracțiunea „conducere periculoasă"</b> — depășirea vitezei, trecerea pe roșu = <b>contravenții</b>. Art. 334 = vehicul <b>neînmatriculat</b>/număr fals. Iar permisul <b>suspendat/anulat</b> = art. 335 alin. 2 (6 luni–3 ani), pedeapsă diferită de lipsa totală a permisului (1–5 ani).',
    ...
    '<b>Uzul de fals</b> — recapitulare: la înscrisurile <b>oficiale</b> → autorul falsului care îl folosește = <b>concurs</b> (fals + uz); la înscrisurile <b>sub semnătură privată</b> → folosirea e element constitutiv al falsului (art. 322), deci o singură infracțiune.',
  ...
  w26:[
    ...
    '<b>Excepțiile procesuale</b>: dilatorii (amână judecata — ex: necompetența, litispendența, conexitatea) vs. peremptorii (sting acțiunea — ex: prescripția, autoritatea de lucru judecat, <b>lipsa calității procesuale</b>, lipsa de interes). ⚠️ Lipsa calității procesuale e <b>peremptorie</b>, nu dilatorie — duce la respingerea acțiunii!',
    '⚠️ <b>Capcana necompetenței</b> (art. 130 NCPC): doar necompetența <b>generală</b> se invocă oricând; cea <b>materială și teritorial-exclusivă</b> (deși de ordine publică!) — numai la <b>primul termen cu părțile legal citate</b> în fața primei instanțe; cea relativă — doar pârâtul, prin întâmpinare. Grilă: „necompetența materială se invocă în orice stare a pricinii" = FALS sub NCPC.',
    '⚠️ <b>Partajul, moștenirea, uzucapiunea → judecătorie INDIFERENT de valoare</b> (art. 94). Grilă: „partajul unui imobil de 1 mil. lei merge la tribunal" = FALS.',
  ...
  w27:[
    ...
    'Limite la urmărirea salariului (art. 729): pensii de întreținere/alocații → până la <b>1/2</b>; orice alte datorii → până la <b>1/3</b>; concurs de urmăriri → total max <b>1/2</b>. Veniturile sub salariul minim: urmăribile doar peste <b>jumătate din salariul minim net</b>.',
    '⚠️ <b>Hotărârea asupra contestației la executare → numai APEL</b> (art. 718 NCPC), nu recurs. Grilă frecventă.',
    '⚠️ <b>Insolvență ≠ insolvabilitate</b>: insolvența = lipsa <b>fondurilor bănești disponibile</b> pentru datoriile scadente (chiar cu activ mare!); insolvabilitatea = pasiv &gt; activ. Pragul insolvenței: <b>50.000 lei</b> (majorat în 2022 de la 40.000). Penalitățile art. 906: 100–1.000 lei/zi (obligații neevaluabile) / <b>0,1–1%/zi</b> (evaluabile).',
  ...
  w28:[
    ...
    '<b>Arestul preventiv</b>: dispus de judecătorul de drepturi și libertăți la propunerea procurorului. În urmărire: câte <b>30 de zile</b>, max <b>180 de zile</b> total. În judecată (primă instanță): verificare la 60 de zile, dar durata totală <b>nu poate depăși jumătate din maximul special</b> și în niciun caz <b>5 ani</b> (art. 239). Controlul judiciar: total max <b>1 an / 2 ani</b> în urmărire (art. 215¹).',
  ...
  tlt:[
    ...
    '⚠️ <b>Capcana opțiunii succesorale</b>: termenul este <b>1 an de la data DESCHIDERII moștenirii</b> (art. 1103 — nu de la cunoaștere, nu 6 luni, nu 3 ani). La expirare fără opțiune → prezumție de renunțare (art. 1112 NCC); dacă a stăpânit bunuri → acceptare tacită.',
    '⚠️ <b>Capcana reabilitării</b>: judecătorească = termene <b>fixe 4/5/7 ani</b> de la executare (nu „+durata pedepsei" — vechiul cod). De drept = 3 ani (amendă, închisoare ≤2 ani, suspendare).',
    '⚠️ <b>Capcana riscului la vânzare</b>: până la <b>predare</b>, riscul e la <b>vânzător</b>, chiar dacă proprietatea s-a transferat (art. 1274 — <i>res perit debitori</i>). „Res perit domino" în contracte = vechiul cod.'
  ]
};
...
(function() {
  ...
  },
  {
    ...
    "c": "contractul de închiriere semnat înainte de intrarea în vigoare a legii noi va fi parțial anulabil dacă prevede o chirie superioară plafonului rezultat din legea nouă.",
    "correct": "B",
