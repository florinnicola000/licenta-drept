...

  {
    ...
    sections:[
      { icon:'✋', title:'Posesia (art. 916–952 NCC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1]</b> Posesia <span style="color:var(--sub);font-size:0.9em">a) viciată nu produce niciun efect juridic · b) poate avea ca obiect bunuri corporale care fac parte dintr-o succesiune · c) încetează atunci când exercitarea elementului material se face prin intermediul altei persoane (corpore alieno)</span> — Răspuns: <b>B)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 916 C.civ., posesia este exercitarea în fapt a prerogativelor dreptului de proprietate asupra unui bun corporal; bun…</span>',
          '📌 <b>[Iul 2026 · G1]</b> Uzucapiunea tabulară presupune <span style="color:var(--sub);font-size:0.9em">a) o durată a posesiei de 10 ani · b) o posesie de bună-credință până la momentul introducerii cererii de chemare în judecată de către adevăratul proprietar · c) un drept real principal înscris, fără cauză legitimă, în cartea funciară</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 931 C.civ., uzucapiunea tabulară privește dreptul real principal înscris fără cauză legitimă în cartea funciară, dob…</span>'
        ]
      },
...

  {
    ...
    sections:[
      { icon:'🏛️', title:'Competența instanțelor (art. 94–147 NCPC)',
        ...
        ,
          '📌 <b>[Iul 2026 · G1]</b> În situația transmisiunii, în condițiile legii, a calității procesuale <span style="color:var(--sub);font-size:0.9em">a) succesorul cu titlu particular nu este obligat să intervină în cauză, dacă are cunoștință de existența procesului · b) hotărârea pronunțată contra înstrăinătorului sau succesorului universal ori cu titlu universal al acestuia va produce de drept efecte și contra succesorului cu titlu particular și va fi întotdeauna opozabilă acestuia din urmă, fără excepție · c) dacă în cursul procesului dreptul litigios este transmis prin acte între vii cu titlu particular, judecata va continua între părțile inițiale</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 39 alin. (1) C.proc.civ., dacă în cursul procesului dreptul litigios este transmis prin acte între vii cu titlu part…</span>',
          '📌 <b>[Iul 2026 · G3]</b> In situația transmisiunii, în condițiile legii, a calității procesuale <span style="color:var(--sub);font-size:0.9em">a) succesorul cu titlu particular nu este obligat să intervină în cauză, dacă are cunoștință de existența procesului · b) hotărârea pronunțată contra înstrăinătorului sau succesorului universal ori cu titlu universal al acestuia va produce de drept efecte și contra succesorului cu titlu particular și va fi întotdeauna opozabilă acestuia din urmă, fără excepție · c) dacă. în cursul procesului dreptul litigios este transmis prin acte între vii cu titlu particular, judecata va continua între părțile inițiale</span> — Răspuns: <b>C)</b> <span style="color:var(--sub);font-size:0.92em">Art. 39 alin. (1) C. proc. civ. prevede expres că dacă în cursul procesului dreptul litigios este transmis prin acte între vii cu…</span>',
          '📌 <b>[Iul 2026 · G1]</b> În cazul coparticipării procesuale <span style="color:var(--sub);font-size:0.9em">a) dacă prin natura raportului juridic , efectele hotărârii se întind asupra tuturor reclamanților ori pârâților, termenele încuviințate numai unora dintre ei pentru îndeplinirea actelor de procedură profită și celorlalți · b) pârâții care nu s-au înfățișat, vor continua să fie citați, chiar dacă au termen în cunoștință · c) principiul independenței procesuale se aplică în toate cazurile</span> — Răspuns: <b>A)</b> <span style="color:var(--sub);font-size:0.92em">potrivit art. 60 alin. (2) C.proc.civ., dacă prin natura raportului juridic sau în temeiul unei dispoziții a legii, efectele hotăr…</span>'
        ]
      },
